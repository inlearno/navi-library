...
const co = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-e4a055fb.js"),
  windowOptions: {
    icon: ur.faUsers,
    title: "Пользователи",
    width: 800
...
const uo = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-cfb5b0ff.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-a36747bf.js"),
  windowOptions: {
  ...
  component: () => import("./Draft-2a0ca138.js"),
  windowOptions: {
