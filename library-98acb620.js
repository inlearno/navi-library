...
const _w = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-383cf485.js"),
  windowOptions: {
    icon: Qu.faUsers,
    title: "Пользователи",
    width: 800
  ...
  id: "user-profile",
  path: "/user-profile",
  component: () => import("./UserProfile-91b5c68b.js"),
  windowOptions: {
    icon: Rd.faUserGear,
    title: "Профиль",
    width: 400,
...
const Aw = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-0d5001ff.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-0fac9cf5.js"),
  privilege: "ProgramDocsView",
  windowOptions: {
  ...
  component: () => import("./Draft-19083c15.js"),
  ...
  component: () => import("./CopyProgramForm-f6e95067.js"),
  windowOptions: {
  ...
  component: () => import("./Dictionaries-5a403b35.js"),
  windowOptions: {
    title: "Справочники",
    width: 700,
    height: 500,
...
const Ew = [{
  ...
  component: () => import("./TeacherProfile-057f9300.js"),
  windowOptions: {
    title: "",
