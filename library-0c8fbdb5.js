...
const _w = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-c41c1802.js"),
  windowOptions: {
    icon: Qu.faUsers,
    title: "Пользователи",
    width: 800
  ...
  id: "user-profile",
  path: "/user-profile",
  component: () => import("./UserProfile-690249d1.js"),
  windowOptions: {
    icon: Rd.faUserGear,
    title: "Профиль",
    width: 400,
...
const Aw = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-ff18fab3.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-ade54d6f.js"),
  privilege: "ProgramDocsView",
  windowOptions: {
  ...
  component: () => import("./Draft-40e0d5bd.js"),
  ...
  privilege: "ProgramDocsEdit",
  component: () => import("./CopyProgramForm-bca47acd.js"),
  windowOptions: {
  ...
  privilege: "ProgramDocsView",
  component: () => import("./Dictionaries-a0388916.js"),
  windowOptions: {
    title: "Справочники",
    width: 700,
    height: 500,
...
const Ew = [{
  ...
  component: () => import("./TeacherProfile-6f24c8a0.js"),
  windowOptions: {
    title: "",
