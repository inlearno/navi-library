...
const ww = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-f7bb5315.js"),
  windowOptions: {
    icon: Qu.faUsers,
    title: "Пользователи",
    width: 800
  ...
  id: "user-profile",
  path: "/user-profile",
  component: () => import("./UserProfile-967a6ac3.js"),
  windowOptions: {
    icon: Dd.faUserGear,
    title: "Профиль",
    width: 400,
...
const _w = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-3ba9fc86.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-0eccd855.js"),
  privilege: "ProgramDocsView",
  windowOptions: {
  ...
  component: () => import("./Draft-872fa5e7.js"),
  ...
  component: () => import("./CopyProgramForm-f9e153f8.js"),
  windowOptions: {
  ...
  component: () => import("./Dictionaries-b646542a.js"),
  windowOptions: {
    title: "Справочники",
    width: 700,
    height: 500,
