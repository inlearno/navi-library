...
import { L as _n, O as wt, P as mi, T as bi, V as $r, W as wi, J as Gt, X as Si, Y as xi, l as yt, b as Ee, j as B, Z as _i, f as On, F as mt, _ as Oi, G as Di } from "./library-36d20a53.js";
import { r as O, R as ne, e as Ei, c as Ht, g as Dn } from "./react-6f5a8403.js";
import { Q as En, d as Ri, e as zi, g as Pi, i as Ti, j as Ci, s as qr, k as Yr, w as Mi, l as ki, m as Ai, u as Rn, c as Ni, f as Li, n as Fi, h as Ct, b as Wi } from "./DictionaryCell-38ba9612.js";
import { F as Ye, p as zn } from "./icons-ad9f8a73.js";
import { B as Bi, A as ji, L as Vi, M as Hi, a as zr, N as Ii, u as Pn, P as Tn, O as Ui, I as $i, f as qi, j as Yi, Q as Xi, R as Xr, S as Qi, U as Ki, V as Gi } from "./mui-0a491bf1.js";
...
function rs({
  ...
  const t = Gt(r), i = Ri(), s = zi(), o = O.useMemo(
    () => e.map((m) => {
...
function Wa(e, n, r) {
  ...
  const i = O.useMemo(() => Si(t.url, {
    encode: encodeURIComponent
  }), [t.url]), s = O.useMemo(() => xi(t.url).reduce((g, m) => typeof m != "string" ? [...g, m.name] : g, []), [t.url]), o = Rn(), {
    wrapPayload: a = !0,
    syncQueryCache: l = !1,
    ...c
  } = t, f = Gt();
...
const Kr = () => {
  ...
  var l;
  const r = e.name ?? `batcher:${Math.random().toString(16).slice(2)})`, t = e.scheduler ?? Cn(10), i = (l = globalThis.__BATSHIT_DEVTOOLS__) == null ? void 0 : l.for(r);
  let s = n ?? {
    seq: 0,
...
}, os = (e) => (n, r) => n.find((t) => t[e] == r), Cn = (e) => (n, r) => {
  const t = r - n;
  return e - t;
}, as = ({
  url: e,
...
function ja(e) {
  const n = O.useRef(null), r = O.useRef(e);
...
var le = (e) => !xe(e) && !Array.isArray(e) && Mn(e) && !ot(e), kn = (e) => le(e) && e.target ? Pt(e.target) ? e.target.checked : e.target.value : e, ds = (e) => e.substring(0, e.search(/\.\d+(\.|$)/)) || e, An = (e, n) => e.has(ds(n)), ps = (e) => {
...
var Nn = (e, n, r, t = !0) => {
  ...
  return i;
}, Ae = (e) => le(e) && !Object.keys(e).length, Ln = (e, n, r, t) => {
  r(e);
  const { name: i, ...s } = e;
...
function gs(e) {
  ...
  return f.current = i, Cr({
    disabled: t,
    next: (h) => l.current && Fn(f.current, h.name, s) && Ln(h, c.current, r._updateFormState) && a({
      ...r._formState,
      ...h
    }),
...
function vs(e) {
  ...
  a.current = t, Cr({
    ...
    next: (f) => {
      Fn(a.current, f.name, o) && c(De(Wn(a.current, r._names, f.values || r._formValues, !1, i)));
    }
  });
  const [l, c] = ne.useState(r._getWatch(t, i));
  return ne.useEffect(() => r._removeUnmounted()), l;
}
var Mr = (e) => /^\w*$/.test(e), Bn = (e) => Tt(e.replace(/["|']|\]/g, "").split(/\.|\[/)), re = (e, n, r) => {
  let t = -1;
  const i = Mr(n) ? [n] : Bn(n), s = i.length, o = s - 1;
  for (; ++t < s; ) {
    const a = i[t];
    let l = r;
    if (t !== o) {
...
function ys(e) {
  ...
  return ne.useEffect(() => {
    ...
    field: {
      name: r,
      value: a,
      ...Fe(t) || l.disabled ? { disabled: l.disabled || t } : {},
...
function rn(e, n, r = "validate") {
  if (Vt(e) || Array.isArray(e) && e.every(Vt) || Fe(e) && !e)
    return {
      type: r,
      message: Vt(e) ? e : "",
      ref: n
...
var it = (e) => le(e) && !$t(e) ? e : {
  ...
  const { ref: s, refs: o, required: a, maxLength: l, minLength: c, min: f, max: h, pattern: p, validate: g, name: m, valueAsNumber: w, mount: T, disabled: R } = e._f, b = P(n, m);
  if (!T || R)
    return {};
  const C = o ? o[0] : s, A = (M) => {
    t && C.reportValidity && (C.setCustomValidity(Fe(M) ? "" : M || ""), C.reportValidity());
  }, N = {}, ee = Ar(s), q = Pt(s), H = ee || q, j = (w || kr(s)) && oe(s.value) && oe(b) || Ut(s) && s.value === "" || b === "" || Array.isArray(b) && !b.length, F = jn.bind(null, m, r, N), U = (M, L, X, J = $e.maxLength, G = $e.minLength) => {
    const K = M ? L : X;
    N[m] = {
      type: M ? J : G,
      message: K,
  ...
  if (i ? !Array.isArray(b) || !b.length : a && (!H && (j || xe(b)) || Fe(b) && !b || q && !Vn(o).isValid || ee && !Hn(o).isValid)) {
    const { value: M, message: L } = Vt(a) ? { value: !!a, message: a } : it(a);
    if (M && (N[m] = {
      type: $e.required,
      message: L,
      ref: C,
  ...
  if (!j && (!xe(f) || !xe(h))) {
    ...
    if (!xe(b) && !isNaN(b)) {
      ...
      xe(X.value) || (M = G > X.value), xe(J.value) || (L = G < J.value);
    } else {
      const G = s.valueAsDate || new Date(b), K = (ie) => /* @__PURE__ */ new Date((/* @__PURE__ */ new Date()).toDateString() + " " + ie), Z = s.type == "time", te = s.type == "week";
      He(X.value) && b && (M = Z ? K(b) > K(X.value) : te ? b > X.value : G > new Date(X.value)), He(J.value) && b && (L = Z ? K(b) < K(J.value) : te ? b < J.value : G < new Date(J.value));
    }
    if ((M || L) && (U(!!M, X.message, J.message, $e.max, $e.min), !r))
      return A(N[m].message), N;
  }
  if ((l || c) && !j && (He(b) || i && Array.isArray(b))) {
    const M = it(l), L = it(c), X = !xe(M.value) && b.length > +M.value, J = !xe(L.value) && b.length < +L.value;
    if ((X || J) && (U(X, M.message, L.message), !r))
      return A(N[m].message), N;
  }
  if (p && !j && He(b)) {
    const { value: M, message: L } = it(p);
    if ($t(M) && !b.match(M) && (N[m] = {
      type: $e.pattern,
      message: L,
      ref: s,
      ...F($e.pattern, L)
  ...
  if (g) {
    if (Je(g)) {
      const M = await g(b, n), L = rn(M, C);
      if (L && (N[m] = {
        ...L,
        ...F($e.validate, L.message)
      }, !r))
...
function ve(e, n) {
  const r = Array.isArray(n) ? n : Mr(n) ? [n] : Bn(n), t = r.length === 1 ? e : ws(e, r), i = r.length - 1, s = r[i];
...
var Mt = (e, n) => $n(e, n, Yt(n)), qn = (e, { valueAsNumber: n, valueAsDate: r, setValueAs: t }) => oe(e) ? e : n ? e === "" ? NaN : e && +e : r && He(e) ? new Date(e) : t ? t(e) : e;
function lr(e) {
  const n = e.ref;
...
function zs(e = {}, n) {
  ...
  const h = {
    ...
    if (k && v) {
      ...
      h.dirtyFields && (t.dirtyFields = Mt(s, o)), p.state.next({
        name: u,
        isDirty: L(u, d),
    ...
    if (z) {
      ...
      oe(_) || k && k.defaultChecked || d ? re(o, u, d ? _ : lr(z._f)) : G(u, _), a.mount && R();
    }
  }, q = (u, d, v, k, z) => {
    let _ = !1, V = !1;
    const se = {
    ...
    if (!v || k) {
      h.isDirty && (V = t.isDirty, t.isDirty = se.isDirty = L(), _ = V !== se.isDirty);
    ...
    const z = P(t.errors, u), _ = h.isValid && Fe(d) && t.isValid !== d;
    ...
    b(!1);
  }, j = async (u) => r.resolver(o, r.context, _s(u || l.mount, i, r.criteriaMode, r.shouldUseNativeValidation)), F = async (u) => {
  ...
  }, L = (u, d) => (u && d && re(o, u, d), !Ze(y(), s)), X = (u, d, v) => Wn(u, l, {
    ...
    if (z) {
      ...
      if (!nt && p.values.next({
        ...
        return h.isValid && R(), vi && p.state.next({ name: v, ...ir ? {} : sr });
    ...
    Fe(u) && (p.state.next({ disabled: u }), bt(i, (d, v) => {
      let k = u;
      const z = P(i, v);
      z && Fe(z._f.disabled) && (k || (k = z._f.disabled)), d.disabled = k;
    }, 0, !1));
  }, he = (u, d) => async (v) => {
    let k;
    ...
    P(i, u) && (oe(d.defaultValue) ? Z(u, De(P(s, u))) : (Z(u, d.defaultValue), re(s, u, De(d.defaultValue))), d.keepTouched || ve(t.touchedFields, u), d.keepDirty || (ve(t.dirtyFields, u), t.isDirty = d.defaultValue ? L(u, De(P(s, u))) : L()), d.keepError || (ve(t.errors, u), h.isValid && R()), p.state.next({ ...t }));
  }, _e = (u, d = {}) => {
    ...
    l = {
      ...
      dirtyFields: d.keepDirtyValues ? d.keepDefaultValues && o ? Mt(s, o) : t.dirtyFields : d.keepDefaultValues && u ? Mt(s, u) : {},
  ...
  return {
    control: {
      ...
      _resetDefaultValues: () => Je(r.defaultValues) && r.defaultValues().then((u) => {
        Me(u, r.resetOptions), p.state.next({
          isLoading: !1
        });
      }),
      _updateFormState: (u) => {
...
function Ps(e = {}) {
  ...
  return s._options = e, Cr({
    subject: s._subjects.state,
    next: (o) => {
      Ln(o, s._proxyFormState, s._updateFormState, !0) && i({ ...s._formState });
    }
    ...
    try {
      return Promise.resolve(function(o, a) {
        ...
        if (function(a) {
          ...
          return { values: {}, errors: Ms(As(o.errors, !s.shouldUseNativeValidation && s.criteriaMode === "all"), s) };
        throw o;
      }));
    } catch (o) {
...
const Fs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  clsx: an,
  default: an
}, Symbol.toStringTag, { value: "Module" })), Ws = /* @__PURE__ */ Ei(Fs);
var ae = {}, Ie = {};
...
var kt = "";
function ni(e, n) {
  return kt || (kt = (0, Ce.findInArray)(["matches", "webkitMatchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector"], function(r) {
    return (0, Ce.isFunction)(e[r]);
  })), (0, Ce.isFunction)(e[kt]) ? e[kt](n) : !1;
}
function Xs(e, n, r) {
  var t = e;
  do {
...
function Gs(e) {
  ...
  return n += (0, Ce.int)(r.borderTopWidth), n += (0, Ce.int)(r.borderBottomWidth), n;
}
function Js(e) {
  var n = e.clientWidth, r = e.ownerDocument.defaultView.getComputedStyle(e);
  return n += (0, Ce.int)(r.borderLeftWidth), n += (0, Ce.int)(r.borderRightWidth), n;
}
function Zs(e) {
  var n = e.clientHeight, r = e.ownerDocument.defaultView.getComputedStyle(e);
  return n -= (0, Ce.int)(r.paddingTop), n -= (0, Ce.int)(r.paddingBottom), n;
}
function eo(e) {
  var n = e.clientWidth, r = e.ownerDocument.defaultView.getComputedStyle(e);
  return n -= (0, Ce.int)(r.paddingLeft), n -= (0, Ce.int)(r.paddingRight), n;
}
function to(e, n, r) {
...
function io(e, n) {
  return e.targetTouches && (0, Ce.findInArray)(e.targetTouches, function(r) {
    return n === r.identifier;
  }) || e.changedTouches && (0, Ce.findInArray)(e.changedTouches, function(r) {
    return n === r.identifier;
  });
}
function so(e) {
...
function po(e, n, r) {
  ...
  if (typeof n == "number" && !t)
    return null;
  var i = Lr(r), s = r.props.offsetParent || i.offsetParent || i.ownerDocument.body;
  return (0, at.offsetXYFromParent)(t || e, s, r.props.scale);
}
function ho(e, n, r) {
  var t = e.state, i = !(0, ze.isNum)(t.lastX), s = Lr(e);
  return i ? {
    node: s,
    deltaX: 0,
    deltaY: 0,
...
er.default = void 0;
var fr = bo(O), Re = Fr(zn), mo = Fr(Ht), ye = ae, Xe = Ue, dr = Ie, vt = Fr(tr);
function Fr(e) {
...
}, Qe = Le.mouse, rr = /* @__PURE__ */ function(e) {
  Eo(r, e);
  var n = Ro(r);
  function r() {
    var t;
      ...
      if (t.state.dragging) {
        ...
        if (l != null) {
          ...
          if (T === !1 || t.mounted === !1)
            return !1;
          var R = t.findDOMNode();
          R && t.props.enableUserSelectHack && (0, ye.removeUserSelectStyles)(R.ownerDocument), (0, vt.default)("DraggableCore: handleDragStop: %j", w), t.setState({
            dragging: !1,
            lastX: NaN,
            lastY: NaN
          }), R && ((0, vt.default)("DraggableCore: Removing handlers"), (0, ye.removeEvent)(R.ownerDocument, Qe.move, t.handleDrag), (0, ye.removeEvent)(R.ownerDocument, Qe.stop, t.handleDragStop));
        }
      }
    }), ke(me(t), "onMouseDown", function(a) {
      return Qe = Le.mouse, t.handleDragStart(a);
    }), ke(me(t), "onMouseUp", function(a) {
      return Qe = Le.mouse, t.handleDragStop(a);
    }), ke(me(t), "onTouchStart", function(a) {
      return Qe = Le.touch, t.handleDragStart(a);
    }), ke(me(t), "onTouchEnd", function(a) {
      return Qe = Le.touch, t.handleDragStop(a);
    }), t;
  }
  return Do(r, [{
    ...
    value: function() {
      ...
      i && (0, ye.addEvent)(i, Le.touch.start, this.onTouchStart, {
        passive: !1
      });
    }
  }, {
    ...
    value: function() {
      ...
      if (i) {
        ...
        (0, ye.removeEvent)(s, Le.mouse.move, this.handleDrag), (0, ye.removeEvent)(s, Le.touch.move, this.handleDrag), (0, ye.removeEvent)(s, Le.mouse.stop, this.handleDragStop), (0, ye.removeEvent)(s, Le.touch.stop, this.handleDragStop), (0, ye.removeEvent)(i, Le.touch.start, this.onTouchStart, {
          passive: !1
...
(function(e) {
  ...
  var r = m(O), t = p(zn), i = p(Ht), s = p(Ws), o = ae, a = Ue, l = Ie, c = p(er), f = p(tr), h = ["axis", "bounds", "children", "defaultPosition", "defaultClassName", "defaultClassNameDragging", "defaultClassNameDragged", "position", "positionOffset", "scale"];
  function p(y) {
  ...
  function m(y, S) {
    ...
    for (var W in y)
      if (W !== "default" && Object.prototype.hasOwnProperty.call(y, W)) {
        var $ = E ? Object.getOwnPropertyDescriptor(y, W) : null;
        $ && ($.get || $.set) ? Object.defineProperty(D, W, $) : D[W] = y[W];
      }
    return D.default = y, x && x.set(y, D), D;
  }
  function w() {
    return w = Object.assign || function(y) {
      for (var S = 1; S < arguments.length; S++) {
        var x = arguments[S];
        for (var D in x)
          Object.prototype.hasOwnProperty.call(x, D) && (y[D] = x[D]);
      }
      return y;
  ...
  function T(y, S) {
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      for (E = 0; E < W.length; E++)
        D = W[E], !(S.indexOf(D) >= 0) && Object.prototype.propertyIsEnumerable.call(y, D) && (x[D] = y[D]);
    }
    return x;
  }
  function R(y, S) {
    if (y == null)
      return {};
    var x = {}, D = Object.keys(y), E, W;
    for (W = 0; W < D.length; W++)
      E = D[W], !(S.indexOf(E) >= 0) && (x[E] = y[E]);
    return x;
  }
  function b(y, S) {
    var x = Object.keys(y);
  ...
  function C(y) {
    for (var S = 1; S < arguments.length; S++) {
      ...
      S % 2 ? b(Object(x), !0).forEach(function(D) {
        ie(y, D, x[D]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(y, Object.getOwnPropertyDescriptors(x)) : b(Object(x)).forEach(function(D) {
        Object.defineProperty(y, D, Object.getOwnPropertyDescriptor(x, D));
      });
    }
    return y;
  }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  function H(y, S) {
    ...
    if (x != null) {
      var D = [], E = !0, W = !1, $, I;
      try {
        for (x = x.call(y); !(E = ($ = x.next()).done) && (D.push($.value), !(S && D.length === S)); E = !0)
          ;
      } catch (Y) {
        W = !0, I = Y;
      } finally {
  ...
  function J(y) {
    ...
    return function() {
      ...
      if (S) {
        ...
        E = Reflect.construct(D, arguments, W);
      } else
  ...
  var pe = /* @__PURE__ */ function(y) {
    ...
    function x(D) {
      var E;
      return F(this, x), E = S.call(this, D), ie(K(E), "onDragStart", function(W, $) {
        (0, f.default)("Draggable: onDragStart: %j", $);
        var I = E.props.onStart(W, (0, a.createDraggableData)(K(E), $));
        if (I === !1)
          return !1;
        E.setState({
          dragging: !0,
      ...
      }), ie(K(E), "onDrag", function(W, $) {
        if (!E.state.dragging)
          return !1;
        (0, f.default)("Draggable: onDrag: %j", $);
        var I = (0, a.createDraggableData)(K(E), $), Y = {
          x: I.x,
          y: I.y
        };
        if (E.props.bounds) {
          var be = Y.x, he = Y.y;
          Y.x += E.state.slackX, Y.y += E.state.slackY;
          var we = (0, a.getBoundPosition)(K(E), Y.x, Y.y), _e = A(we, 2), Me = _e[0], Be = _e[1];
          Y.x = Me, Y.y = Be, Y.slackX = E.state.slackX + (be - Y.x), Y.slackY = E.state.slackY + (he - Y.y), I.x = Y.x, I.y = Y.y, I.deltaX = Y.x - E.state.x, I.deltaY = Y.y - E.state.y;
        }
        var Se = E.props.onDrag(W, I);
        if (Se === !1)
          return !1;
        E.setState(Y);
      }), ie(K(E), "onDragStop", function(W, $) {
        if (!E.state.dragging)
          return !1;
        var I = E.props.onStop(W, (0, a.createDraggableData)(K(E), $));
        if (I === !1)
          return !1;
        ...
        if (be) {
          var he = E.props.position, we = he.x, _e = he.y;
          Y.x = we, Y.y = _e;
        }
        E.setState(Y);
      }), E.state = {
        ...
        prevPropsPosition: C({}, D.position),
    ...
    return M(x, [{
      ...
      value: function() {
        var E, W, $;
        return (E = (W = this.props) === null || W === void 0 || ($ = W.nodeRef) === null || $ === void 0 ? void 0 : $.current) !== null && E !== void 0 ? E : i.default.findDOMNode(this);
      }
    }, {
      key: "render",
      value: function() {
        ...
        W.scale;
        var Me = T(W, h), Be = {}, Se = null, Ne = !!we, u = !Ne || this.state.dragging, d = we || I, v = {
        ...
        var k = (0, s.default)($.props.className || "", Y, (E = {}, ie(E, be, this.state.dragging), ie(E, he, this.state.dragged), E));
        return /* @__PURE__ */ r.createElement(c.default, w({}, Me, {
          onStart: this.onDragStart,
          onDrag: this.onDrag,
          onStop: this.onDragStop
        }), /* @__PURE__ */ r.cloneElement(r.Children.only($), {
          className: k,
          style: C(C({}, $.props.style), Be),
          transform: Se
        }));
      }
    }], [{
      ...
      value: (
        ...
        // Arity (props, state)
        function(E, W) {
          var $ = E.position, I = W.prevPropsPosition;
  ...
  e.default = pe, ie(pe, "displayName", "Draggable"), ie(pe, "propTypes", C(C({}, c.default.propTypes), {}, {
    /**
  ...
  })), ie(pe, "defaultProps", C(C({}, c.default.defaultProps), {}, {
    axis: "both",
    bounds: !1,
...
var ko = globalThis && globalThis.__extends || function() {
  ...
  function(e) {
    ...
    return n.prototype.render = function() {
      return O.createElement("div", { className: this.props.className || "", style: Kt(Kt({ position: "absolute", userSelect: "none" }, Ao[this.props.direction]), this.props.replaceStyles || {}), onMouseDown: this.onMouseDown, onTouchStart: this.onTouchStart }, this.props.children);
    }, n;
  }(O.PureComponent)
), Wr = { exports: {} };
function Lo(e, n) {
...
var Uo = globalThis && globalThis.__extends || function() {
  ...
  return t = Lt(t, e.width, n, r), i = Lt(i, e.height, n, r), s = Lt(s, e.width, n, r), o = Lt(o, e.height, n, r), {
  ...
  function(e) {
    ...
    return Object.defineProperty(n.prototype, "parentNode", {
      ...
      if (a) {
        var T = (p - m) * this.ratio + w, R = (g - m) * this.ratio + w, b = (f - w) / this.ratio + m, C = (h - w) / this.ratio + m, A = Math.max(f, T), N = Math.min(h, R), ee = Math.max(p, b), q = Math.min(g, C);
      ...
      if (!(!this.state.isResizing || !this.resizable || !this.window)) {
        ...
        var R = this.calculateNewSizeFromDirection(l, c), b = R.newHeight, C = R.newWidth, A = this.calculateNewMaxFromBoundary(i, s);
        this.props.snap && this.props.snap.x && (C = hn(C, this.props.snap.x, this.props.snapGap)), this.props.snap && this.props.snap.y && (b = hn(b, this.props.snap.y, this.props.snapGap));
        var N = this.calculateNewSizeFromAspectRatio(C, b, { width: A.maxWidth, height: A.maxHeight }, { width: o, height: a });
        if (C = N.newWidth, b = N.newHeight, this.props.grid) {
          var ee = pn(C, this.props.grid[0]), q = pn(b, this.props.grid[1]), H = this.props.snapGap || 0;
          C = H === 0 || Math.abs(ee - C) <= H ? ee : C, b = H === 0 || Math.abs(q - b) <= H ? q : b;
        }
        var j = {
          width: C - p.width,
          height: b - p.height
        ...
        if (g && typeof g == "string") {
          if (de(g, "%")) {
            ...
            var U = C / this.window.innerWidth * 100;
            C = U + "vw";
          } else if (de(g, "vh")) {
            var M = C / this.window.innerHeight * 100;
            C = M + "vh";
          }
        }
        if (m && typeof m == "string") {
          if (de(m, "%")) {
            var F = b / w.height * 100;
            b = F + "%";
          } else if (de(m, "vw")) {
        ...
        this.flexDir === "row" ? L.flexBasis = L.width : this.flexDir === "column" && (L.flexBasis = L.height), this.setState(L), this.props.onResize && this.props.onResize(r, h, this.resizable, j);
      }
      ...
      var f = Object.keys(i).map(function(h) {
        return i[h] !== !1 ? O.createElement(No, { key: h, direction: h, onResizeStart: r.onResizeStart, replaceStyles: s && s[h], className: o && o[h] }, c && c[h] ? c[h] : null) : null;
      });
      return O.createElement("div", { className: l, style: a }, f);
    ...
    return n.prototype.componentDidMount = function() {
      ...
      if (this.originalPosition = i, !!this.props.bounds) {
        ...
        if (this.props.bounds === "parent")
          ...
          if (!this.resizable)
            return;
          var T = s.getBoundingClientRect(), R = T.left, b = T.top, C = -(R - s.offsetLeft * o) / o, A = -(b - s.offsetTop * o) / o, m = (window.innerWidth - this.resizable.size.width * o) / o + C, w = (window.innerHeight - this.resizable.size.height * o) / o + A;
          return this.setState({ bounds: { top: A, right: m, bottom: w, left: C } });
        } else
        ...
        if (!(!(a instanceof HTMLElement) || !(s instanceof HTMLElement))) {
          var N = a.getBoundingClientRect(), ee = N.left, q = N.top, H = s.getBoundingClientRect(), j = H.left, F = H.top, U = (ee - j) / o, M = q - F;
          if (this.resizable) {
            this.updateOffsetFromParent();
      ...
      if (this.resizingPosition = { x: a.x + o.left, y: a.y + o.top }, this.originalPosition = a, this.props.bounds) {
        ...
        if (f instanceof Element && (c instanceof HTMLElement || c === window) && l instanceof HTMLElement) {
          ...
          var T = f.getBoundingClientRect(), R = T.left, b = T.top, C = this.props.bounds === "window" ? { left: 0, top: 0 } : c.getBoundingClientRect(), A = C.left, N = C.top, ee = this.getOffsetWidth(c), q = this.getOffsetHeight(c), H = t.toLowerCase().endsWith("left"), j = t.toLowerCase().endsWith("right"), F = t.startsWith("top"), U = t.startsWith("bottom");
          if ((H || F) && this.resizable) {
            var M = (R - A) / s + this.resizable.size.width;
            this.setState({ maxWidth: M > Number(p) ? p : M });
          }
          if (j || this.props.lockAspectRatio && !H && !F) {
            var M = ee + (A - R) / s;
            this.setState({ maxWidth: M > Number(p) ? p : M });
          }
      ...
      return O.createElement(
        ...
        O.createElement(Qo, ue({}, H, { ref: this.refResizable, defaultSize: j, size: this.props.size, enable: typeof b == "boolean" ? ea(b) : b, onResizeStart: this.onResizeStart, onResize: this.onResize, onResizeStop: this.onResizeStop, style: U, minWidth: this.props.minWidth, minHeight: this.props.minHeight, maxWidth: this.state.resizing ? this.state.maxWidth : this.props.maxWidth, maxHeight: this.state.resizing ? this.state.maxHeight : this.props.maxHeight, grid: C, handleWrapperClass: A, handleWrapperStyle: N, lockAspectRatio: this.props.lockAspectRatio, lockAspectRatioExtraWidth: this.props.lockAspectRatioExtraWidth, lockAspectRatioExtraHeight: this.props.lockAspectRatioExtraHeight, handleStyles: w, handleClasses: T, handleComponent: R, scale: this.props.scale }), m)
      );
    }, n.defaultProps = {
...
const ta = [{
  ...
  const N = O.useCallback((H) => {
    c || (w(!0), C == null || C(H));
  }, [c, w, C]), ee = O.useCallback((H) => {
    var j;
    if (l) {
      const F = vn(H.target, !0);
      F !== H.target.value && (H.target.value = F, (j = A.onChange) == null || j.call(A, F));
    }
    w(!1), b == null || b(H);
  }, [w, b]);
  ...
  const X = O.useCallback((u) => s && s in u ? u[s] : JSON.stringify(u), [s]), [J, G] = O.useState(l);
  O.useEffect(() => {
    G(l);
  }, [l]);
  const K = O.useMemo(() => a ? (A == null ? void 0 : A.map((u) => o.find((d) => d[i] == u)).filter((u) => !!u)) || [] : o.find((u) => u[i] == A) || null, [A, o]), {
    value: Z,
    getRootProps: te,
    getInputProps: ie,
    getListboxProps: pe,
    ...
    onChange: (u, d) => {
      w && (Array.isArray(d) ? w(d.map((v) => v[i])) : w(d && typeof d == "object" ? d[i] : null)), R == null || R(d);
    }
  }), I = O.useMemo(() => j ? j({
    closePopup: () => G(!1)
    ...
    zIndex: "20",
    width: "100%"
  }, ...pe(), children: E && S.length > 0 ? /* @__PURE__ */ Ee(mt, { children: [
    ...
    I
  ] }) : I }), be = O.useMemo(() => a ? Z && Z.length > 0 : !!Z, [Z, a]), {
    onBlur: he,
    onChange: we,
    ref: _e,
    ...Me
  } = ie(), Be = Pn(L, _e), Se = O.useMemo(() => a ? U ? U({
    items: Z,
    isLoading: t,
    onDelete: (u) => {
    ...
    F === "top" && Se,
    /* @__PURE__ */ B(ht, { ...M, error: h, ...Me, ref: Be, inputWrapRef: D, placeholder: C, isLoading: r, useTypograf: !1, onChange: we, onBlur: (u) => {
    ...
    E && /* @__PURE__ */ B(Tn, { open: W, anchorEl: E, children: /* @__PURE__ */ B("div", { css: [{
      marginTop: "0.125rem",
      "--tw-bg-opacity": "1",
...
const _r = (e) => Array.isArray(e) ? e.length === 0 : !e, ua = ({
  ...
  const [o, a] = O.useState(n), l = Fi(e, {
    enabled: o || !!r
  });
  O.useEffect(() => {
    a(n);
  }, [n]);
  const c = O.useMemo(() => t && l.data ? t(l.data) : l.data, [l.data, t]);
  return /* @__PURE__ */ B(
    di,
    {
      displayField: "name",
...
function ya(e, n) {
  return O.useCallback(function(r) {
...
function ba(e) {
  var n = e.init, r = e.tracking, t = e.eventType, i = e.eventHandler, s = O.useRef({ timeoutId: -1, fallbackTimeoutId: -1, cachedTimeoutId: -1, start: 0, end: 0 }), o = O.useRef(!0), a = O.useRef(null), l = O.useRef({ init: n, tracking: r, eventType: t, eventHandler: i });
  return l.current.init = n, l.current.tracking = r, l.current.eventType = t, l.current.eventHandler = i, O.useMemo(function() {
    return function(c, f, h) {
      var p = h.onFocus, g = h.onBlur, m = h.onInput;
      return new Proxy(c, { set: function(w, T, R) {
        if (T !== "current")
          return !1;
        var b = R !== null && ma.includes(R.type);
        if (R !== c.current && (c.current !== null && (c.current.removeEventListener("focus", p), c.current.removeEventListener("blur", g), c.current.removeEventListener("input", m)), R !== null && b)) {
          var C, A = (C = R._wrapperState) !== null && C !== void 0 ? C : {}, N = A.controlled, ee = N !== void 0 && N, q = A.initialValue, H = q === void 0 ? "" : q, j = f({ controlled: ee, initialValue: R.value || H });
          Ft(R, { value: j.value }), document.activeElement === R && p(), R.addEventListener("focus", p), R.addEventListener("blur", g), R.addEventListener("input", m);
        }
        return w[T] = R, !0;
      } });
      ...
      if (f !== null)
        try {
          ...
          var T = f.value, R = f.selectionStart, b = f.selectionEnd;
          if (R === null || b === null)
            throw new ut("The selection attributes have not been initialized.");
          var C, A = (h = (p = f._valueTracker) === null || p === void 0 || (g = p.getValue) === null || g === void 0 ? void 0 : g.call(p)) !== null && h !== void 0 ? h : "";
          if (R > s.current.start ? C = "insert" : R <= s.current.start && R < s.current.end ? C = "deleteBackward" : R === s.current.end && T.length < A.length && (C = "deleteForward"), C === void 0 || (C === "deleteBackward" || C === "deleteForward") && T.length > A.length)
            throw new ut("Input type detection error.");
          var N = "", ee = "", q = s.current.start, H = s.current.end;
          if (C === "insert")
            N = T.slice(s.current.start, R);
          else {
            var j = A.length - T.length;
            q = R, H = R + j, ee = A.slice(q, H);
          }
          var F = l.current.tracking({ inputType: C, previousValue: A, value: T, addedValue: N, deletedValue: ee, changeStart: q, changeEnd: H, selectionStart: R, selectionEnd: b });
          Ft(f, { value: F.value, selectionStart: F.selectionStart, selectionEnd: F.selectionEnd });
          var U = l.current.eventType, M = l.current.eventHandler;
          if (typeof U == "string" && M) {
            var L = f.value, X = f.selectionStart, J = f.selectionEnd;
            o.current = !1, requestAnimationFrame(function() {
              Ft(f, { value: L, selectionStart: X ?? L.length, selectionEnd: J ?? L.length });
              var Y = new CustomEvent(U, { bubbles: !0, cancelable: !1, composed: !0, detail: F.__detail });
              f.dispatchEvent(Y), Ht.unstable_batchedUpdates ? Ht.unstable_batchedUpdates(M, Y) : M(Y), o.current = !0;
            });
          }
          (m = f._valueTracker) === null || m === void 0 || (w = m.setValue) === null || w === void 0 || w.call(m, A), s.current.start = F.selectionStart, s.current.end = F.selectionEnd;
        } catch (Y) {
          var G, K, Z, te, ie, pe, y, S, x, D, E, W = Y, $ = W.name, I = W.cause;
          if (Ft(f, { value: (G = (K = I == null || (Z = I.__attributes) === null || Z === void 0 ? void 0 : Z.value) !== null && K !== void 0 ? K : (te = f._valueTracker) === null || te === void 0 || (ie = te.getValue) === null || ie === void 0 ? void 0 : ie.call(te)) !== null && G !== void 0 ? G : "", selectionStart: (pe = I == null || (y = I.__attributes) === null || y === void 0 ? void 0 : y.selectionStart) !== null && pe !== void 0 ? pe : s.current.start, selectionEnd: (S = I == null || (x = I.__attributes) === null || x === void 0 ? void 0 : x.selectionEnd) !== null && S !== void 0 ? S : s.current.end }), (I == null || (D = I.__attributes) === null || D === void 0 ? void 0 : D.selectionStart) !== void 0 && (s.current.start = I.__attributes.selectionStart), (I == null || (E = I.__attributes) === null || E === void 0 ? void 0 : E.selectionEnd) !== void 0 && (s.current.end = I.__attributes.selectionEnd), c.preventDefault(), c.stopPropagation(), $ !== "SyntheticChangeError")
            throw Y;
        }
    } });
  }, []);
...
function Hr() {
  var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, n = e.mask, r = n === void 0 ? "" : n, t = e.replacement, i = t === void 0 ? {} : t, s = e.showMask, o = s !== void 0 && s, a = e.separate, l = a !== void 0 && a, c = e.track, f = e.modify, h = e.onMask, p = typeof i == "string" ? Dr(i) : i, g = O.useRef(null);
  return ba({ init: function(m) {
    var w = m.controlled, T = m.initialValue;
    T = w || T ? T : o ? r : "";
    var R = { mask: r, replacement: p, showMask: o, separate: l };
    return g.current = { value: T, props: R, fallbackProps: R }, { value: T };
  }, tracking: function(m) {
    var w, T = m.inputType, R = m.previousValue, b = m.addedValue, C = m.changeStart, A = m.changeEnd;
    if (g.current === null)
    ...
    var N = bn(R, { end: C, mask: g.current.props.mask, replacement: g.current.props.replacement, separate: g.current.props.separate }), ee = RegExp("[^".concat(Object.keys(g.current.props.replacement).join(""), "]"), "g"), q = g.current.props.mask.replace(ee, "");
    N && (N = hr(N, { replacementChars: q, replacement: g.current.props.replacement, separate: g.current.props.separate }));
    var H = c == null ? void 0 : c(Or(Or({}, T === "insert" ? { inputType: T, data: b } : { inputType: T, data: null }), {}, { value: R, selectionStart: C, selectionEnd: A }));
    if (H === !1)
    ...
    var j = bn(R, { start: A, mask: g.current.props.mask, replacement: g.current.props.replacement, separate: g.current.props.separate });
    if (g.current.props.separate) {
      var F = g.current.props.mask.slice(C, A).replace(ee, ""), U = F.length - b.length;
      U < 0 ? j = j.slice(-U) : U > 0 && (j = F.slice(-U) + j);
    }
    ...
    var M = N + b + j, L = (w = f == null ? void 0 : f(M)) !== null && w !== void 0 ? w : {}, X = L.mask, J = X === void 0 ? r : X, G = L.replacement, K = G === void 0 ? p : G, Z = L.showMask, te = Z === void 0 ? o : Z, ie = L.separate, pe = ie === void 0 ? l : ie;
    typeof K == "string" && (K = Dr(K));
    var y = function(x, D) {
      var E = D.mask, W = D.replacement, $ = D.showMask, I = fa(x, { mask: E, replacement: W, showMask: $ }), Y = da(I, { mask: E, replacement: W }), be = wn({ mask: E, replacement: W }), he = wn({ mask: E, replacement: W }, !0);
      return { value: I, input: x, parts: Y, pattern: be, isValid: RegExp(he).test(I) };
    }(M, { mask: J, replacement: K, showMask: te }), S = function(x) {
      var D, E, W, $ = x.inputType, I = x.value, Y = x.addedValue, be = x.beforeChangeValue, he = x.parts, we = x.replacement, _e = x.separate, Me = he.filter(function(d) {
        var v = d.type;
        return v === "input" || _e && v === "replacement";
      }), Be = (D = Me[be.length + Y.length - 1]) === null || D === void 0 ? void 0 : D.index, Se = (E = Me[be.length - 1]) === null || E === void 0 ? void 0 : E.index, Ne = (W = Me[be.length + Y.length]) === null || W === void 0 ? void 0 : W.index;
      if ($ === "insert") {
        if (Be !== void 0)
          return Be + 1;
        if (Ne !== void 0)
...
const xa = ({
  ...
  const [m, w] = O.useState(null), [T, R] = O.useState(!1), [b, C] = O.useState(!1), [A, N] = O.useState(a ? Ct(a).format("DD.MM.YYYY") : "");
  g = Hr({
    mask: c,
    replacement: f,
    showMask: h,
    track: (F) => {
      const {
        ...
        selectionEnd: L,
        selectionStart: X
      } = F, [J, G, K] = (U == null ? void 0 : U.split(".")) || [], Z = (ie) => L === ie && X === ie, te = M !== null;
      return Z(0) && te && !/[0123]/.test(M) || Z(1) && te && (J == null ? void 0 : J[0]) === "3" && +M > 1 || Z(1) && te && (J == null ? void 0 : J[0]) === "0" && +M == 0 || Z(2) && te && !/[01]/.test(M) || Z(4) && te && (G == null ? void 0 : G[0]) === "1" && !/[012]/.test(M) || Z(4) && te && (G == null ? void 0 : G[0]) === "0" && +M < 1 || Z(5) && te && !/[12]/.test(M) || Z(7) && te && (K == null ? void 0 : K[0]) === "1" && +M != 9 ? !1 : F.data;
    }
  }), O.useEffect(() => {
    r !== void 0 && R(r);
  }, [r]);
  const q = O.useCallback((F) => {
    C(!0), R(!0), i == null || i(F);
  }, [i, R]), H = (F) => {
    C(!1), A && (l == null || l(Ct(A, "DD-MM-YYYY").format("YYYY-MM-DD"))), s == null || s(F);
  }, j = O.useCallback((F) => {
    w(F);
  }, [w]);
  return /* @__PURE__ */ B(Xi, { onClickAway: () => R(!1), children: /* @__PURE__ */ Ee(Jt, { className: t, label: n, error: e, children: [
    /* @__PURE__ */ B(ht, { ...p, inputWrapRef: j, ref: g, onFocus: q, onBlur: H, useTypograf: !1, value: A, onChange: (F) => {
    ...
    m && /* @__PURE__ */ B(Tn, { open: T, anchorEl: m, placement: "bottom-start", modifiers: [{
      ...
      "--tw-drop-shadow": "drop-shadow(0 10px 8px rgb(0 0 0 / 0.04)) drop-shadow(0 4px 3px rgb(0 0 0 / 0.1))",
      filter: "var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)"
    }, children: /* @__PURE__ */ B(Oi, { value: a, onChange: (F) => {
      l == null || l(Ct(F).format("YYYY-MM-DD")), N(Ct(F).format("DD.MM.YYYY")), R(!1);
    } }) }) })
  ] }) });
}, Ya = O.forwardRef(xa), _a = ({
  multiple: e,
  value: n,
  url: r,
  params: t,
  ...
  const [h, p] = O.useState(""), [g, m] = O.useState(a), w = cs(h, 500), T = ls(r, i), {
    records: R,
    isLoading: b
  } = us({
    idField: i,
  ...
  const C = O.useMemo(() => ({
    ...
    var j;
    return yt.uniqBy([...R, ...((j = N.data) == null ? void 0 : j.data) || []], i);
  }, [R, N.data]), q = !e && b, H = l ? (j) => l({
    ...j,
    search: h,
  ...
  return /* @__PURE__ */ B(mt, { children: /* @__PURE__ */ B(di, { ref: f, multiple: e, value: n, ...c, disabled: q || c.disabled, inputLoading: q, options: ee, idField: i, onOpen: () => m(!0), onClose: () => m(!1), isLoading: N.isLoading || b, valueLoading: b, popupAdditionalOptionsRenderer: H, open: g, afterItems: [(N.isLoading || N.isFetching || e && b) && /* @__PURE__ */ B("div", { children: /* @__PURE__ */ B(Ye, { icon: On.faCircleNotch, css: {
    ...
    e ? j == null || j.map((U) => {
      T(U);
    }) : T(j), (F = c.onSelect) == null || F.call(c, j);
  }, onInputChange: (j, F, U) => {
    U === "input" && p(F), U === "reset" && h !== "" && p(""), s == null || s(j, F, U);
  } }) });
}, Xa = O.forwardRef(_a), Oa = ({
  unit: e,
  error: n,
  onChange: r,
  allowFloat: t = !0,
  ...
  const [a, l] = O.useState(i), [c, f] = O.useState(null);
  O.useEffect(() => {
    l(i);
  }, [i]);
  const h = Pn(o, f);
...
}, Qa = O.forwardRef(Oa), Da = O.forwardRef(({
  placeholder: e = "Введите",
  ...n
  ...
  rows: n = 5,
  ...r
}, t) => /* @__PURE__ */ B(ht, { ...r, ref: t, rows: n, inputComponent: Da, error: e }), Ka = O.forwardRef(Ea), Ra = ({
  error: e,
  ...n
}, r) => /* @__PURE__ */ B(ht, { useTypograf: !1, ...n, ref: r, error: e }), Ga = O.forwardRef(Ra), za = ({
  label: e,
  error: n,
  value: r,
  helperText: t,
  ...
  replacement: n,
  showMask: r
}), /* @__PURE__ */ B(ht, { useTypograf: !1, ...t, ref: i })), eu = O.forwardRef(Ta);
export {
  Ba as B,
  ms as C,
  qa as D,
