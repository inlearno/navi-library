...
import { I as si, J as sr, L as oi, O as cn, b as Ee, j as V, f as fn, F as ft, P as ai, G as ui, l as li } from "./library-e4cc27e1.js";
...
import { r as M, R as re, e as wi, c as kt, g as hn } from "./react-6f5a8403.js";
import { F as Ge, p as gn } from "./icons-ad9f8a73.js";
import { f as Si } from "./faEye-db6d14ba.js";
import { Q as vn, d as xi, e as _i, g as Oi, i as Di, j as Ei, s as Nr, k as Fr, w as zi, l as Ri, u as Pi, c as Ti, f as Mi, m as Ci, h as _t, b as ki } from "./DictionaryCell-c555a711.js";
function Lr(e, n) {
...
const Ii = ({
  ...
  return /* @__PURE__ */ Ee("form", { className: n, onSubmit: r.onSubmit, children: [
    t.root && /* @__PURE__ */ Ee(ci, { severity: "error", children: [
      ((i = t.root.error) == null ? void 0 : i.message) && /* @__PURE__ */ V(fi, { css: [{
        fontSize: "0.875rem",
        lineHeight: "1.25rem"
      }, !t.root.fields && {
        margin: "0px"
      }], children: (s = t.root.error) == null ? void 0 : s.message }),
      t.root.fields && /* @__PURE__ */ V("ul", { css: {
        ...
        message: a
      }]) => /* @__PURE__ */ V("li", { css: {}, children: a }, o)) })
    ] }),
    e
  ] });
}, ga = Ii;
...
var Ve = (e) => typeof e == "string", On = (e, n, r, t, i) => Ve(e) ? (t && n.watch.add(e), R(r, e, i)) : Array.isArray(e) ? e.map((s) => (t && n.watch.add(s), R(r, s))) : (t && (n.watchAll = !0), r);
function Xi(e) {
...
}, Ct = (e) => Ve(e), Or = (e) => e.type === "radio", Ft = (e) => e instanceof RegExp;
const jr = {
  value: !1,
  isValid: !1
...
var et = (e) => ue(e) && !Ft(e) ? e : {
  ...
  if (!C || E)
    return {};
  const P = o ? o[0] : s, A = (T) => {
    t && P.reportValidity && (P.setCustomValidity(Ne(T) ? "" : T || ""), P.reportValidity());
  }, N = {}, Z = Or(s), q = wt(s), H = Z || q, B = (S || _r(s)) && se(s.value) && se(b) || Nt(s) && s.value === "" || b === "" || Array.isArray(b) && !b.length, L = En.bind(null, m, r, N), U = (T, F, X, K = Ue.maxLength, G = Ue.minLength) => {
    const Q = T ? F : X;
    N[m] = {
      type: T ? K : G,
      message: Q,
  ...
  if (!B && (!we(d) || !we(h))) {
    ...
    if (!we(b) && !isNaN(b)) {
      ...
      Ve(X.value) && b && (T = J ? Q(b) > Q(X.value) : ee ? b > X.value : G > new Date(X.value)), Ve(K.value) && b && (F = J ? Q(b) < Q(K.value) : ee ? b < K.value : G < new Date(K.value));
    }
    if ((T || F) && (U(!!T, X.message, K.message, Ue.max, Ue.min), !r))
      return A(N[m].message), N;
  }
  if ((l || c) && !B && (Ve(b) || i && Array.isArray(b))) {
...
var Ot = (e, n) => Mn(e, n, Wt(n)), Cn = (e, { valueAsNumber: n, valueAsDate: r, setValueAs: t }) => se(e) ? e : n ? e === "" ? NaN : e && +e : r && Ve(e) ? new Date(e) : t ? t(e) : e;
function Zt(e) {
  const n = e.ref;
  ...
  const h = {
    ...
    if (k && v) {
      if (a.action = !0, _ && Array.isArray(R(i, u))) {
        const j = v(R(i, u), k.argA, k.argB);
        z && te(i, u, j);
      }
      if (_ && Array.isArray(R(t.errors, u))) {
        const j = v(R(t.errors, u), k.argA, k.argB);
        z && te(t.errors, u, j), is(t.errors, u);
      }
      if (h.touchedFields && _ && Array.isArray(R(t.touchedFields, u))) {
        const j = v(R(t.touchedFields, u), k.argA, k.argB);
    ...
    if (!v || k) {
      h.isDirty && (j = t.isDirty, t.isDirty = ie.isDirty = F(), _ = j !== ie.isDirty);
      const We = le || Xe(R(s, u), f);
      j = !!(!le && R(t.dirtyFields, u)), We || le ? he(t.dirtyFields, u) : te(t.dirtyFields, u, !0), ie.dirtyFields = t.dirtyFields, _ = _ || h.dirtyFields && j !== !We;
    }
    if (v) {
    ...
    if (k) {
      const _ = k._f;
      _ && (!_.disabled && te(o, u, Cn(f, _)), z = Nt(_.ref) && we(f) ? "" : f, Pn(_.ref) ? [..._.ref.options].forEach((j) => j.selected = z.includes(j.value)) : _.refs ? wt(_.ref) ? _.refs.length > 1 ? _.refs.forEach((j) => (!j.defaultChecked || !j.disabled) && (j.checked = Array.isArray(z) ? !!z.find((ie) => ie === j.value) : z === j.value)) : _.refs[0] && (_.refs[0].checked = !!z) : _.refs.forEach((j) => j.checked = j.value === z) : _r(_.ref) ? _.ref.value = "" : (_.ref.value = z, _.ref.type || p.values.next({
        name: u,
        values: { ...o }
      })));
    }
    ...
    for (const k in f) {
      const z = f[k], _ = `${u}.${k}`, j = R(i, _);
      (l.array.has(u) || !Lt(z) || j && !j._f) && !rt(z) ? Q(_, z, v) : G(_, z, v);
    }
  }, J = (u, f, v = {}) => {
    ...
    const f = u.target;
    let v = f.name, k = !0;
    const z = R(i, v), _ = () => f.type ? Zt(z._f) : bn(u), j = (ie) => {
      k = Number.isNaN(ie) || ie === R(o, v, ie);
    };
    if (z) {
      let ie, le;
      const We = _(), Ze = u.type === At.BLUR || u.type === At.FOCUS_OUT, ri = !rs(z._f) && !r.resolver && !R(t.errors, v) && !z._f.deps || ns(Ze, R(t.touchedFields, v), t.isSubmitted, m, g), Xt = Vr(v, l, Ze);
      ...
      if (!Ze && Xt && p.state.next({ ...t }), b(!0), r.resolver) {
        ...
        ie = (await $r(z, o, S, r.shouldUseNativeValidation))[v], j(We), k && (ie ? le = !1 : h.isValid && (le = await U(i, !0)));
    ...
    return se(u) ? f : Ve(u) ? R(f, u) : u.map((v) => R(f, v));
  }, w = (u, f) => ({
    ...
    return te(i, u, {
      ...
      ref: (z) => {
        if (z) {
          I(u, f), v = R(i, u);
          const _ = se(z.value) && z.querySelectorAll && z.querySelectorAll("input,select,textarea")[0] || z, j = es(_), ie = v._f.refs || [];
    ...
    if (p.state.next({
      ...
      const { errors: _, values: j } = await B();
      t.errors = _, z = j;
    } else
      await U(i);
...
Ut.default = void 0;
var tr = Gs(M), _e = zr(gn), Qs = zr(kt), ge = oe, $e = He, rr = je, ct = zr($t);
function zr(e) {
...
(function(e) {
  ...
  var r = m(M), t = p(gn), i = p(kt), s = p(vs), o = oe, a = He, l = je, c = p(Ut), d = p($t), h = ["axis", "bounds", "children", "defaultPosition", "defaultClassName", "defaultClassNameDragging", "defaultClassNameDragged", "position", "positionOffset", "scale"];
  function p(y) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var de = /* @__PURE__ */ function(y) {
    ...
    function x(O) {
      ...
      return L(this, x), D = w.call(this, O), ne(Q(D), "onDragStart", function(W, $) {
        ...
        prevPropsPosition: P({}, O.position),
  ...
  e.default = de, ne(de, "displayName", "Draggable"), ne(de, "propTypes", P(P({}, c.default.propTypes), {}, {
    /**
  ...
  })), ne(de, "defaultProps", P(P({}, c.default.defaultProps), {}, {
    axis: "both",
    bounds: !1,
...
var co = globalThis && globalThis.__extends || function() {
  ...
  function(e) {
    ...
    return n.prototype.render = function() {
      return M.createElement("div", { className: this.props.className || "", style: jt(jt({ position: "absolute", userSelect: "none" }, fo[this.props.direction]), this.props.replaceStyles || {}), onMouseDown: this.onMouseDown, onTouchStart: this.onTouchStart }, this.props.children);
    }, n;
  }(M.PureComponent)
), Rr = { exports: {} };
function ho(e, n) {
...
var xo = globalThis && globalThis.__extends || function() {
  ...
  function(e) {
    ...
    return Object.defineProperty(n.prototype, "parentNode", {
      ...
      if (a) {
        var C = (p - m) * this.ratio + S, E = (g - m) * this.ratio + S, b = (d - S) / this.ratio + m, P = (h - S) / this.ratio + m, A = Math.max(d, C), N = Math.min(h, E), Z = Math.max(p, b), q = Math.min(g, P);
      ...
      if (!(!this.state.isResizing || !this.resizable || !this.window)) {
        ...
        var E = this.calculateNewSizeFromDirection(l, c), b = E.newHeight, P = E.newWidth, A = this.calculateNewMaxFromBoundary(i, s);
        this.props.snap && this.props.snap.x && (P = tn(P, this.props.snap.x, this.props.snapGap)), this.props.snap && this.props.snap.y && (b = tn(b, this.props.snap.y, this.props.snapGap));
        var N = this.calculateNewSizeFromAspectRatio(P, b, { width: A.maxWidth, height: A.maxHeight }, { width: o, height: a });
        if (P = N.newWidth, b = N.newHeight, this.props.grid) {
          var Z = en(P, this.props.grid[0]), q = en(b, this.props.grid[1]), H = this.props.snapGap || 0;
          P = H === 0 || Math.abs(Z - P) <= H ? Z : P, b = H === 0 || Math.abs(q - b) <= H ? q : b;
        }
        var B = {
          width: P - p.width,
          height: b - p.height
        ...
        if (g && typeof g == "string") {
          if (fe(g, "%")) {
            ...
            var T = P / this.window.innerHeight * 100;
            P = T + "vh";
          }
        }
    ...
    return n.prototype.componentDidMount = function() {
      ...
      if (this.originalPosition = i, !!this.props.bounds) {
        ...
        if (this.props.bounds === "parent")
          ...
          if (!this.resizable)
            return;
          var C = s.getBoundingClientRect(), E = C.left, b = C.top, P = -(E - s.offsetLeft * o) / o, A = -(b - s.offsetTop * o) / o, m = (window.innerWidth - this.resizable.size.width * o) / o + P, S = (window.innerHeight - this.resizable.size.height * o) / o + A;
          return this.setState({ bounds: { top: A, right: m, bottom: S, left: P } });
        } else
        ...
        if (!(!(a instanceof HTMLElement) || !(s instanceof HTMLElement))) {
          var N = a.getBoundingClientRect(), Z = N.left, q = N.top, H = s.getBoundingClientRect(), B = H.left, L = H.top, U = (Z - B) / o, T = q - L;
          if (this.resizable) {
            this.updateOffsetFromParent();
      ...
      if (this.resizingPosition = { x: a.x + o.left, y: a.y + o.top }, this.originalPosition = a, this.props.bounds) {
        ...
        if (d instanceof Element && (c instanceof HTMLElement || c === window) && l instanceof HTMLElement) {
          ...
          var C = d.getBoundingClientRect(), E = C.left, b = C.top, P = this.props.bounds === "window" ? { left: 0, top: 0 } : c.getBoundingClientRect(), A = P.left, N = P.top, Z = this.getOffsetWidth(c), q = this.getOffsetHeight(c), H = t.toLowerCase().endsWith("left"), B = t.toLowerCase().endsWith("right"), L = t.startsWith("top"), U = t.startsWith("bottom");
          if ((H || L) && this.resizable) {
            var T = (E - A) / s + this.resizable.size.width;
      ...
      return M.createElement(
        ...
        M.createElement(zo, ae({}, H, { ref: this.refResizable, defaultSize: B, size: this.props.size, enable: typeof b == "boolean" ? Co(b) : b, onResizeStart: this.onResizeStart, onResize: this.onResize, onResizeStop: this.onResizeStop, style: U, minWidth: this.props.minWidth, minHeight: this.props.minHeight, maxWidth: this.state.resizing ? this.state.maxWidth : this.props.maxWidth, maxHeight: this.state.resizing ? this.state.maxHeight : this.props.maxHeight, grid: P, handleWrapperClass: A, handleWrapperStyle: N, lockAspectRatio: this.props.lockAspectRatio, lockAspectRatioExtraWidth: this.props.lockAspectRatioExtraWidth, lockAspectRatioExtraHeight: this.props.lockAspectRatioExtraHeight, handleStyles: S, handleClasses: C, handleComponent: E, scale: this.props.scale }), m)
      );
    }, n.defaultProps = {
...
const ko = [{
  ...
  ...n
}, r) => /* @__PURE__ */ V("input", { ref: r, placeholder: e, css: {
  appearance: "none",
  ...
  let q = /* @__PURE__ */ Ee("div", { className: r, ref: t, css: [{
    ...
    d && /* @__PURE__ */ Ee("div", { css: {
      ...
      /* @__PURE__ */ V(Ge, { icon: fn.faCircleNotch, css: {
        "--tw-text-opacity": "1",
        color: "rgb(156 163 175 / var(--tw-text-opacity))"
      }, spin: !0, size: "sm" }),
      " ",
  ...
  return e && (q = /* @__PURE__ */ V(Ht, { label: e, error: o, helperText: n, ...C(), children: q })), q;
}, xt = M.forwardRef(No), Fo = ({
  getTagProps: e,
  optionRender: n,
  getOptionLabel: r,
  items: t,
  ...
  backgroundColor: "rgb(229 230 244 / var(--tw-bg-opacity))"
              ...
              height: 30px;
            `] }, a)) }) : t && (t == null ? void 0 : t.length) > 0 && /* @__PURE__ */ V("div", { css: {
  marginBottom: "0.25rem",
  display: "flex",
  flexWrap: "wrap",
  gap: "0.5rem"
  ...
  return /* @__PURE__ */ Ee("div", { ...d, css: {
    ...
    /* @__PURE__ */ V("span", { children: n ? n(o) : r(o) }),
    /* @__PURE__ */ V("button", { onClick: l, children: /* @__PURE__ */ V(Ge, { icon: Tr.faTimes, css: {
      "--tw-text-opacity": "1",
      color: "rgb(156 163 175 / var(--tw-text-opacity))"
    } }) })
  ] }, c);
  ...
  const Q = M.useMemo(() => a ? (A == null ? void 0 : A.map((u) => o.find((f) => f[i] == u)).filter((u) => !!u)) || [] : o.find((u) => u[i] == A) || null, [A, o]), {
    ...
    closePopup: () => G(!1)
  }) : null, [B, G]), Y = n ? /* @__PURE__ */ V("div", { css: {
    zIndex: "20",
    display: "flex",
    height: "100%",
    width: "100%",
    ...
    "--tw-text-opacity": "1",
    color: "rgb(107 114 128 / var(--tw-text-opacity))"
  }, children: /* @__PURE__ */ V(Lo, {}) }) : /* @__PURE__ */ V("ul", { css: {
    zIndex: "20",
    width: "100%"
  }, ...de(), children: D && w.length > 0 ? /* @__PURE__ */ Ee(ft, { children: [
    w.map((u, f) => /* @__PURE__ */ V(re.Fragment, { children: "group" in u ? /* @__PURE__ */ V(ft, {}) : /* @__PURE__ */ V("li", { css: [{
      cursor: "pointer",
      "--tw-border-opacity": "1",
    ...
    ref: Se,
    ...Re
  } = ne(), Le = dn(F, Se), be = M.useMemo(() => a ? U ? U({
    items: J,
    isLoading: t,
    onDelete: (u) => {
  ...
  }) : /* @__PURE__ */ V(Fo, { items: J, optionRender: m, getOptionLabel: X, getTagProps: $, isLoading: t, valueCount: A == null ? void 0 : A.length }) : null, [J, U]), ke = /* @__PURE__ */ Ee(ft, { children: [
    L === "top" && be,
    /* @__PURE__ */ V(xt, { ...T, error: h, ...Re, ref: Le, inputWrapRef: O, placeholder: P, isLoading: r, useTypograf: !1, onChange: me, onBlur: (u) => {
    ...
    }, afterItems: !b && [H && /* @__PURE__ */ V(re.Fragment, { children: H }, "after-items"), ye && N && !a && /* @__PURE__ */ V("button", { ...x(), onMouseDown: (u) => {
      u.preventDefault(), u.stopPropagation();
    }, children: /* @__PURE__ */ V(Ge, { css: {
      fontSize: "0.875rem",
      lineHeight: "1.25rem",
      "--tw-text-opacity": "1",
      color: "rgb(156 163 175 / var(--tw-text-opacity))"
    }, icon: Tr.faTimes }) }, "clear"), /* @__PURE__ */ V("button", { onClick: (u) => {
    ...
    D && /* @__PURE__ */ V(pn, { open: W, anchorEl: D, children: /* @__PURE__ */ V("div", { css: [{
      marginTop: "0.125rem",
      "--tw-bg-opacity": "1",
  ...
  return /* @__PURE__ */ Ee(ft, { children: [
    /* @__PURE__ */ V(Ht, { label: c, error: h, helperText: d, className: e, ...ee(), children: ke }),
    L === "bottom" && be
  ] });
}, Jn = M.forwardRef(Wo), Bo = (e, n) => {
  const [r, t] = M.useState(!1);
  return /* @__PURE__ */ V(vi, { ref: n, type: r ? "text" : "password", InputProps: {
    endAdornment: /* @__PURE__ */ V(hi, { position: "end", children: /* @__PURE__ */ V(gi, { size: "small", edge: "end", onClick: () => t((i) => !i), children: /* @__PURE__ */ V(Ge, { css: [{
      fontSize: "0.875rem",
      lineHeight: "1.25rem"
    }, mr`
                  width: 18px;
...
M.forwardRef(Bo);
const pr = (e) => Array.isArray(e) ? e.length === 0 : !e, Vo = ({
  dictionary: e,
  open: n = !1,
  value: r,
  filterOptions: t,
...
function Zn(e, n, r) {
  return (n = jo(n)) in e ? Object.defineProperty(e, n, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[n] = r, e;
}
function Ho(e, n) {
  if (e == null)
    return {};
    ...
    return function(c, d, h) {
      ...
      return new Proxy(c, { set: function(S, C, E) {
        ...
        if (E !== c.current && (c.current !== null && (c.current.removeEventListener("focus", p), c.current.removeEventListener("blur", g), c.current.removeEventListener("input", m)), E !== null && b)) {
          var P, A = (P = E._wrapperState) !== null && P !== void 0 ? P : {}, N = A.controlled, Z = N !== void 0 && N, q = A.initialValue, H = q === void 0 ? "" : q, B = d({ controlled: Z, initialValue: E.value || H });
      ...
      if (d !== null)
        try {
          ...
          var P, A = (h = (p = d._valueTracker) === null || p === void 0 || (g = p.getValue) === null || g === void 0 ? void 0 : g.call(p)) !== null && h !== void 0 ? h : "";
          if (E > s.current.start ? P = "insert" : E <= s.current.start && E < s.current.end ? P = "deleteBackward" : E === s.current.end && C.length < A.length && (P = "deleteForward"), P === void 0 || (P === "deleteBackward" || P === "deleteForward") && C.length > A.length)
          ...
          var L = l.current.tracking({ inputType: P, previousValue: A, value: C, addedValue: N, deletedValue: Z, changeStart: q, changeEnd: H, selectionStart: E, selectionEnd: b });
...
function ti() {
  ...
  return Ko({ init: function(m) {
    ...
    var S, C = m.inputType, E = m.previousValue, b = m.addedValue, P = m.changeStart, A = m.changeEnd;
    if (g.current === null)
    ...
    var N = an(E, { end: P, mask: g.current.props.mask, replacement: g.current.props.replacement, separate: g.current.props.separate }), Z = RegExp("[^".concat(Object.keys(g.current.props.replacement).join(""), "]"), "g"), q = g.current.props.mask.replace(Z, "");
    N && (N = ir(N, { replacementChars: q, replacement: g.current.props.replacement, separate: g.current.props.separate }));
    var H = c == null ? void 0 : c(hr(hr({}, C === "insert" ? { inputType: C, data: b } : { inputType: C, data: null }), {}, { value: E, selectionStart: P, selectionEnd: A }));
    if (H === !1)
    ...
    if (g.current.props.separate) {
      var L = g.current.props.mask.slice(P, A).replace(Z, ""), U = L.length - b.length;
    ...
    var T = N + b + B, F = (S = d == null ? void 0 : d(T)) !== null && S !== void 0 ? S : {}, X = F.mask, K = X === void 0 ? r : X, G = F.replacement, Q = G === void 0 ? p : G, J = F.showMask, ee = J === void 0 ? o : J, ne = F.separate, de = ne === void 0 ? l : ne;
...
const ea = ({
  ...
  const [m, S] = M.useState(null), [C, E] = M.useState(!1), [b, P] = M.useState(!1), [A, N] = M.useState(a ? _t(a).format("DD.MM.YYYY") : "");
  g = ti({
    mask: c,
    replacement: d,
    showMask: h,
  ...
  const q = M.useCallback((L) => {
    ...
    P(!1), A && (l == null || l(_t(A, "DD-MM-YYYY").format("YYYY-MM-DD"))), s == null || s(L);
  }, B = M.useCallback((L) => {
    S(L);
  }, [S]);
  return /* @__PURE__ */ V(mi, { onClickAway: () => E(!1), children: /* @__PURE__ */ Ee(Ht, { className: t, label: n, error: e, children: [
    /* @__PURE__ */ V(xt, { ...p, inputWrapRef: B, ref: g, onFocus: q, onBlur: H, useTypograf: !1, value: A, onChange: (L) => {
      N == null || N(L.target.value);
    }, onMouseDown: (L) => {
      b && E(!C), o == null || o(L);
    }, error: e }),
    m && /* @__PURE__ */ V(pn, { open: C, anchorEl: m, placement: "bottom-start", modifiers: [{
      name: "arrow",
      enabled: !0,
      options: {
        element: m
      ...
      "--tw-drop-shadow": "drop-shadow(0 10px 8px rgb(0 0 0 / 0.04)) drop-shadow(0 4px 3px rgb(0 0 0 / 0.1))",
      filter: "var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)"
    }, children: /* @__PURE__ */ V(ai, { value: a, onChange: (L) => {
      l == null || l(_t(L).format("YYYY-MM-DD")), N(_t(L).format("DD.MM.YYYY")), E(!1);
    } }) }) })
  ] }) });
}, wa = M.forwardRef(ea), ta = ({
  multiple: e,
  value: n,
  url: r,
  params: t,
  ...
  const [h, p] = M.useState(""), [g, m] = M.useState(a), S = Hi(h, 500), C = ji(r, i), {
    records: E,
    isLoading: b
  } = Vi({
    idField: i,
  ...
  const h = dn(o, d);
  return /* @__PURE__ */ V(xt, { ...s, ref: h, error: n, value: a, useTypograf: !1, onChange: (p) => {
...
}, xa = M.forwardRef(ra), na = M.forwardRef(({
  placeholder: e = "Введите",
  ...n
}, r) => /* @__PURE__ */ V("textarea", { ref: r, placeholder: e, ...n })), ia = ({
  error: e,
  rows: n = 5,
  ...r
}, t) => /* @__PURE__ */ V(xt, { ...r, ref: t, rows: n, inputComponent: na, error: e }), _a = M.forwardRef(ia), sa = ({
  error: e,
  ...n
}, r) => /* @__PURE__ */ V(xt, { useTypograf: !1, ...n, ref: r, error: e }), Oa = M.forwardRef(sa), oa = ({
  label: e,
  error: n,
  value: r,
  helperText: t,
  ...
  onChange: s,
  ...o
}, a) => /* @__PURE__ */ V(Ht, { label: e, error: n, helperText: t, className: i, children: /* @__PURE__ */ Ee(bi, { value: r === !0 ? "true" : r === !1 ? "false" : void 0, ...o, onChange: (l) => {
  s == null || s(l.target.value === "true");
}, ref: a, size: "small", css: {
  marginTop: "0.25rem"
}, children: [
  /* @__PURE__ */ V(Ar, { value: "true", css: {
    paddingLeft: "0.5rem",
    paddingRight: "0.5rem",
    paddingTop: "0.25rem",
