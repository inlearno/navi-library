...
function Zn(e, t) {
  t === void 0 && (t = {});
  for (var r = Yn(e), n = t.prefixes, s = n === void 0 ? "./" : n, i = "[^".concat($e(t.delimiter || "/#?"), "]+?"), o = [], u = 0, w = 0, E = "", l = function(q) {
...
X.HttpStatusCode = io;
X.default = X;
const zr = X, jn = H.createContext(null), Fo = () => H.useContext(jn), oo = ({
  children: e,
  baseURL: t
}) => {
...
const ao = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-cf3217c9.js"),
  windowOptions: {
    icon: ur.faUsers,
    title: "Пользователи",
    width: 800
...
const co = [{
  ...
  component: () => import("./ProgramConstructor-3c26e6dd.js"),
  windowOptions: {
