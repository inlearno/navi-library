...
import { J as _n, L as wt, O as mi, P as bi, T as $r, V as wi, I as Gt, W as Si, X as xi, l as yt, b as Ee, j as B, Y as _i, f as On, F as mt, Z as Oi, G as Di } from "./library-edebc13d.js";
import { r as R, R as ne, e as Ei, c as Ht, g as Dn } from "./react-6f5a8403.js";
import { Q as En, d as Ri, e as zi, g as Pi, i as Mi, j as Ti, s as qr, k as Yr, w as Ci, l as ki, m as Ai, u as Rn, c as Ni, f as Fi, n as Li, h as Tt, b as Wi } from "./DictionaryCell-0ed6c265.js";
import { F as Ye, p as zn } from "./icons-ad9f8a73.js";
import { B as Bi, A as ji, k as Vi, l as Hi, a as zr, m as Ii, u as Pn, P as Mn, o as Ui, I as $i, f as qi, j as Yi, C as Xi, p as Xr, q as Qi, M as Ki, F as Gi } from "./mui-d84d21b5.js";
...
var et, lt, ct, Pe, _t, ft, dt, Wt, Ot, gr, Dt, vr, Et, yr, Rt, mr, Sn, es = (Sn = class extends _n {
...
}, Sn), Ke, Ge, Me, qe, pt, Bt, zt, br, xn, ts = (xn = class extends _n {
  constructor(n, r) {
    super();
    fe(this, pt);
    fe(this, zt);
  ...
  setOptions(n) {
    ...
    this.options = Q(this, Ke).defaultMutationOptions(n), bi(this.options, r) || Q(this, Ke).getMutationCache().notify({
      ...
      mutation: Q(this, Me),
      observer: this
    }), r != null && r.mutationKey && this.options.mutationKey && $r(r.mutationKey) !== $r(this.options.mutationKey) ? this.reset() : (t = Q(this, Me)) == null || t.setOptions(this.options);
  }
  onUnsubscribe() {
    var n;
    this.hasListeners() || (n = Q(this, Me)) == null || n.removeObserver(this);
  }
  onMutationUpdate(n) {
  ...
  reset() {
    var n;
    (n = Q(this, Me)) == null || n.removeObserver(this), Oe(this, Me, void 0), ge(this, pt, Bt).call(this), ge(this, zt, br).call(this);
  }
  mutate(n, r) {
    var t;
    return Oe(this, qe, r), (t = Q(this, Me)) == null || t.removeObserver(this), Oe(this, Me, Q(this, Ke).getMutationCache().build(Q(this, Ke), this.options)), Q(this, Me).addObserver(this), Q(this, Me).execute(n);
  }
}, Ke = new WeakMap(), Ge = new WeakMap(), Me = new WeakMap(), qe = new WeakMap(), pt = new WeakSet(), Bt = function() {
  var r;
  const n = ((r = Q(this, Me)) == null ? void 0 : r.state) ?? wi();
  Oe(this, Ge, {
    ...n,
  ...
  const g = l.find(
    (m, w) => {
      ...
      return M && ki({
        ...
        query: t.getQueryCache().get(M.queryHash)
      });
    }
  );
  if (g != null && g.error)
...
}, os = (e) => (n, r) => n.find((t) => t[e] == r), Tn = (e) => (n, r) => {
  const t = r - n;
  return e - t;
}, as = ({
  url: e,
...
var Mt = (e) => Array.isArray(e) ? e.filter(Boolean) : [], oe = (e) => e === void 0, P = (e, n, r) => {
  if (!n || !le(e))
    return r;
  const t = Mt(n.split(/[,[\].]+?/)).reduce((i, s) => xe(i) ? i : i[s], e);
...
const It = {
  ...
  required: "required",
  validate: "validate"
}, hs = ne.createContext(null), Mr = () => ne.useContext(hs);
var Nn = (e, n, r, t = !0) => {
  const i = {
...
function gs(e) {
  const n = Mr(), { control: r = n.control, disabled: t, name: i, exact: s } = e || {}, [o, a] = ne.useState(r._formState), l = ne.useRef(!0), c = ne.useRef({
    isDirty: !1,
    isLoading: !1,
    dirtyFields: !1,
    touchedFields: !1,
...
function vs(e) {
  const n = Mr(), { control: r = n.control, name: t, defaultValue: i, disabled: s, exact: o } = e || {}, a = ne.useRef(t);
  a.current = t, Tr({
    disabled: s,
...
var Cr = (e) => /^\w*$/.test(e), Bn = (e) => Mt(e.replace(/["|']|\]/g, "").split(/\.|\[/)), re = (e, n, r) => {
  let t = -1;
...
function ys(e) {
  const n = Mr(), { name: r, disabled: t, control: i = n.control, shouldUnregister: s } = e, o = An(i._names.array, r), a = vs({
    control: i,
    name: r,
...
var it = (e) => le(e) && !$t(e) ? e : {
  ...
  const { ref: s, refs: o, required: a, maxLength: l, minLength: c, min: f, max: h, pattern: p, validate: g, name: m, valueAsNumber: w, mount: M, disabled: E } = e._f, b = P(n, m);
  if (!M || E)
    return {};
  const T = o ? o[0] : s, A = (C) => {
    t && T.reportValidity && (T.setCustomValidity(Le(C) ? "" : C || ""), T.reportValidity());
...
var Ds = (e, n, r, t, i) => i.isOnAll ? !1 : !r && i.isOnTouch ? !(n || e) : (r ? t.isOnBlur : i.isOnBlur) ? !e : (r ? t.isOnChange : i.isOnChange) ? e : !0, Es = (e, n) => !Mt(P(e, n)).length && ve(e, n);
const Rs = {
  mode: We.onSubmit,
...
function zs(e = {}, n) {
  ...
  const h = {
    ...
    array: ar(),
    state: ar()
  }, g = Gr(r.mode), m = Gr(r.reValidateMode), w = r.criteriaMode === We.all, M = (u) => (d) => {
    ...
    if (e.delayError && v ? (c = M(() => A(u, v)), c(e.delayError)) : (clearTimeout(f), c = null, v ? re(t.errors, u, v) : ve(t.errors, u)), (v ? !Ze(z, v) : z) || !Ae(k) || _) {
      const V = {
        ...k,
        ..._ && Le(d) ? { isValid: d } : {},
        errors: t.errors,
  ...
  }, v, d), J = (u) => Mt(P(a.mount ? o : s, u, e.shouldUnregister ? P(s, u, []) : [])), G = (u, d, v = {}) => {
    const k = P(i, u);
    let z = d;
    if (k) {
      const _ = k._f;
...
var kt = "";
function ni(e, n) {
  return kt || (kt = (0, Te.findInArray)(["matches", "webkitMatchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector"], function(r) {
    return (0, Te.isFunction)(e[r]);
  })), (0, Te.isFunction)(e[kt]) ? e[kt](n) : !1;
}
function Xs(e, n, r) {
  var t = e;
  do {
...
function Gs(e) {
  ...
  return n += (0, Te.int)(r.borderTopWidth), n += (0, Te.int)(r.borderBottomWidth), n;
}
function Js(e) {
  var n = e.clientWidth, r = e.ownerDocument.defaultView.getComputedStyle(e);
  return n += (0, Te.int)(r.borderLeftWidth), n += (0, Te.int)(r.borderRightWidth), n;
}
function Zs(e) {
  var n = e.clientHeight, r = e.ownerDocument.defaultView.getComputedStyle(e);
  return n -= (0, Te.int)(r.paddingTop), n -= (0, Te.int)(r.paddingBottom), n;
}
function eo(e) {
  var n = e.clientWidth, r = e.ownerDocument.defaultView.getComputedStyle(e);
  return n -= (0, Te.int)(r.paddingLeft), n -= (0, Te.int)(r.paddingRight), n;
}
function to(e, n, r) {
...
function io(e, n) {
  return e.targetTouches && (0, Te.findInArray)(e.targetTouches, function(r) {
    return n === r.identifier;
  }) || e.changedTouches && (0, Te.findInArray)(e.changedTouches, function(r) {
    return n === r.identifier;
  });
}
function so(e) {
    ...
    return t = n.call.apply(n, [this].concat(s)), ke(me(t), "state", {
      ...
      if (t.state.dragging) {
        ...
        if (l != null) {
          ...
          var w = (0, Xe.createCoreData)(me(t), c, f), M = t.props.onStop(a, w);
          if (M === !1 || t.mounted === !1)
            return !1;
          var E = t.findDOMNode();
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var pe = /* @__PURE__ */ function(y) {
    ...
    return C(x, [{
      ...
      value: function() {
        ...
        W.scale;
        var Ce = M(W, h), Be = {}, Se = null, Ne = !!we, u = !Ne || this.state.dragging, d = we || I, v = {
  ...
  e.default = pe, ie(pe, "displayName", "Draggable"), ie(pe, "propTypes", T(T({}, c.default.propTypes), {}, {
    /**
  ...
  })), ie(pe, "defaultProps", T(T({}, c.default.defaultProps), {}, {
    axis: "both",
    bounds: !1,
...
var ai = Kn, ui = ai.default, Mo = ai.DraggableCore;
Zt.exports = ui;
Zt.exports.default = ui;
Zt.exports.DraggableCore = Mo;
var To = Zt.exports;
const Co = /* @__PURE__ */ Dn(To);
...
var Uo = globalThis && globalThis.__extends || function() {
  ...
  function(e) {
    ...
    return Object.defineProperty(n.prototype, "parentNode", {
      ...
      var i = this.props.scale || 1, s = this.props.resizeRatio || 1, o = this.state, a = o.direction, l = o.original, c = this.props, f = c.lockAspectRatio, h = c.lockAspectRatioExtraHeight, p = c.lockAspectRatioExtraWidth, g = l.width, m = l.height, w = h || 0, M = p || 0;
      return st("right", a) && (g = l.width + (r - l.x) * s / i, f && (m = (g - M) / this.ratio + w)), st("left", a) && (g = l.width - (r - l.x) * s / i, f && (m = (g - M) / this.ratio + w)), st("bottom", a) && (m = l.height + (t - l.y) * s / i, f && (g = (m - w) * this.ratio + M)), st("top", a) && (m = l.height - (t - l.y) * s / i, f && (g = (m - w) * this.ratio + M)), { newWidth: g, newHeight: m };
      ...
      if (a) {
        var M = (p - m) * this.ratio + w, E = (g - m) * this.ratio + w, b = (f - w) / this.ratio + m, T = (h - w) / this.ratio + m, A = Math.max(f, M), N = Math.min(h, E), ee = Math.max(p, b), q = Math.min(g, T);
      ...
      if (!(!this.state.isResizing || !this.resizable || !this.window)) {
        ...
        var t = this.props, i = t.maxWidth, s = t.maxHeight, o = t.minWidth, a = t.minHeight, l = Nt(r) ? r.touches[0].clientX : r.clientX, c = Nt(r) ? r.touches[0].clientY : r.clientY, f = this.state, h = f.direction, p = f.original, g = f.width, m = f.height, w = this.getParentSize(), M = Yo(w, this.window.innerWidth, this.window.innerHeight, i, s, o, a);
        i = M.maxWidth, s = M.maxHeight, o = M.minWidth, a = M.minHeight;
        var E = this.calculateNewSizeFromDirection(l, c), b = E.newHeight, T = E.newWidth, A = this.calculateNewMaxFromBoundary(i, s);
        this.props.snap && this.props.snap.x && (T = hn(T, this.props.snap.x, this.props.snapGap)), this.props.snap && this.props.snap.y && (b = hn(b, this.props.snap.y, this.props.snapGap));
        ...
        if (T = N.newWidth, b = N.newHeight, this.props.grid) {
          var ee = pn(T, this.props.grid[0]), q = pn(b, this.props.grid[1]), H = this.props.snapGap || 0;
          T = H === 0 || Math.abs(ee - T) <= H ? ee : T, b = H === 0 || Math.abs(q - b) <= H ? q : b;
        }
        var j = {
          width: T - p.width,
          height: b - p.height
        ...
        if (g && typeof g == "string") {
          if (de(g, "%")) {
            ...
            var C = T / this.window.innerHeight * 100;
            T = C + "vh";
          }
        }
    ...
    return n.prototype.componentDidMount = function() {
      ...
      if (this.originalPosition = i, !!this.props.bounds) {
        ...
        if (this.props.bounds === "parent")
          ...
          if (!this.resizable)
            return;
          var M = s.getBoundingClientRect(), E = M.left, b = M.top, T = -(E - s.offsetLeft * o) / o, A = -(b - s.offsetTop * o) / o, m = (window.innerWidth - this.resizable.size.width * o) / o + T, w = (window.innerHeight - this.resizable.size.height * o) / o + A;
          return this.setState({ bounds: { top: A, right: m, bottom: w, left: T } });
        } else
      ...
      if (this.resizingPosition = { x: a.x + o.left, y: a.y + o.top }, this.originalPosition = a, this.props.bounds) {
        ...
        if (f instanceof Element && (c instanceof HTMLElement || c === window) && l instanceof HTMLElement) {
          ...
          var M = f.getBoundingClientRect(), E = M.left, b = M.top, T = this.props.bounds === "window" ? { left: 0, top: 0 } : c.getBoundingClientRect(), A = T.left, N = T.top, ee = this.getOffsetWidth(c), q = this.getOffsetHeight(c), H = t.toLowerCase().endsWith("left"), j = t.toLowerCase().endsWith("right"), L = t.startsWith("top"), U = t.startsWith("bottom");
      ...
      return R.createElement(
        ...
        R.createElement(Qo, ue({}, H, { ref: this.refResizable, defaultSize: j, size: this.props.size, enable: typeof b == "boolean" ? ea(b) : b, onResizeStart: this.onResizeStart, onResize: this.onResize, onResizeStop: this.onResizeStop, style: U, minWidth: this.props.minWidth, minHeight: this.props.minHeight, maxWidth: this.state.resizing ? this.state.maxWidth : this.props.maxWidth, maxHeight: this.state.resizing ? this.state.maxHeight : this.props.maxHeight, grid: T, handleWrapperClass: A, handleWrapperStyle: N, lockAspectRatio: this.props.lockAspectRatio, lockAspectRatioExtraWidth: this.props.lockAspectRatioExtraWidth, lockAspectRatioExtraHeight: this.props.lockAspectRatioExtraHeight, handleStyles: w, handleClasses: M, handleComponent: E, scale: this.props.scale }), m)
      );
    }, n.defaultProps = {
...
const ta = [{
  ...
  return e && (q = /* @__PURE__ */ B(Jt, { label: e, error: o, helperText: n, ...M(), children: q })), q;
  ...
  const K = R.useMemo(() => a ? (A == null ? void 0 : A.map((u) => o.find((d) => d[i] == u)).filter((u) => !!u)) || [] : o.find((u) => u[i] == A) || null, [A, o]), {
    ...
    L === "top" && Se,
    /* @__PURE__ */ B(ht, { ...C, error: h, ...Ce, ref: Be, inputWrapRef: O, placeholder: T, isLoading: r, useTypograf: !1, onChange: we, onBlur: (u) => {
    ...
    D && /* @__PURE__ */ B(Mn, { open: W, anchorEl: D, children: /* @__PURE__ */ B("div", { css: [{
      marginTop: "0.125rem",
      "--tw-bg-opacity": "1",
...
function ba(e) {
  ...
  return l.current.init = n, l.current.tracking = r, l.current.eventType = t, l.current.eventHandler = i, R.useMemo(function() {
    return function(c, f, h) {
      ...
      return new Proxy(c, { set: function(w, M, E) {
        if (M !== "current")
          return !1;
        ...
        if (E !== c.current && (c.current !== null && (c.current.removeEventListener("focus", p), c.current.removeEventListener("blur", g), c.current.removeEventListener("input", m)), E !== null && b)) {
          var T, A = (T = E._wrapperState) !== null && T !== void 0 ? T : {}, N = A.controlled, ee = N !== void 0 && N, q = A.initialValue, H = q === void 0 ? "" : q, j = f({ controlled: ee, initialValue: E.value || H });
      ...
      if (f !== null)
        try {
          ...
          var M = f.value, E = f.selectionStart, b = f.selectionEnd;
          if (E === null || b === null)
            throw new ut("The selection attributes have not been initialized.");
          var T, A = (h = (p = f._valueTracker) === null || p === void 0 || (g = p.getValue) === null || g === void 0 ? void 0 : g.call(p)) !== null && h !== void 0 ? h : "";
          if (E > s.current.start ? T = "insert" : E <= s.current.start && E < s.current.end ? T = "deleteBackward" : E === s.current.end && M.length < A.length && (T = "deleteForward"), T === void 0 || (T === "deleteBackward" || T === "deleteForward") && M.length > A.length)
            throw new ut("Input type detection error.");
          var N = "", ee = "", q = s.current.start, H = s.current.end;
          if (T === "insert")
            N = M.slice(s.current.start, E);
          else {
            var j = A.length - M.length;
            q = E, H = E + j, ee = A.slice(q, H);
          }
          var L = l.current.tracking({ inputType: T, previousValue: A, value: M, addedValue: N, deletedValue: ee, changeStart: q, changeEnd: H, selectionStart: E, selectionEnd: b });
...
function Hr() {
  ...
  return ba({ init: function(m) {
    var w = m.controlled, M = m.initialValue;
    M = w || M ? M : o ? r : "";
    var E = { mask: r, replacement: p, showMask: o, separate: l };
    return g.current = { value: M, props: E, fallbackProps: E }, { value: M };
  }, tracking: function(m) {
    var w, M = m.inputType, E = m.previousValue, b = m.addedValue, T = m.changeStart, A = m.changeEnd;
    if (g.current === null)
    ...
    var N = bn(E, { end: T, mask: g.current.props.mask, replacement: g.current.props.replacement, separate: g.current.props.separate }), ee = RegExp("[^".concat(Object.keys(g.current.props.replacement).join(""), "]"), "g"), q = g.current.props.mask.replace(ee, "");
    N && (N = hr(N, { replacementChars: q, replacement: g.current.props.replacement, separate: g.current.props.separate }));
    var H = c == null ? void 0 : c(Or(Or({}, M === "insert" ? { inputType: M, data: b } : { inputType: M, data: null }), {}, { value: E, selectionStart: T, selectionEnd: A }));
    if (H === !1)
      throw new ut("Custom trekking stop.");
    if (H === null ? b = "" : H !== !0 && H !== void 0 && (b = H), b && (b = hr(b, { replacementChars: q.slice(N.length), replacement: g.current.props.replacement, separate: !1 })), M === "insert" && b === "")
    ...
    if (g.current.props.separate) {
      var L = g.current.props.mask.slice(T, A).replace(ee, ""), U = L.length - b.length;
    ...
    }({ inputType: M, value: y.value, addedValue: b, beforeChangeValue: N, parts: y.parts, replacement: K, separate: pe });
...
const xa = ({
  ...
  const [m, w] = R.useState(null), [M, E] = R.useState(!1), [b, T] = R.useState(!1), [A, N] = R.useState(a ? Tt(a).format("DD.MM.YYYY") : "");
  g = Hr({
    mask: c,
    replacement: f,
    showMask: h,
  ...
  const q = R.useCallback((L) => {
    ...
    T(!1), A && (l == null || l(Tt(A, "DD-MM-YYYY").format("YYYY-MM-DD"))), s == null || s(L);
  }, j = R.useCallback((L) => {
    w(L);
  }, [w]);
  return /* @__PURE__ */ B(Xi, { onClickAway: () => E(!1), children: /* @__PURE__ */ Ee(Jt, { className: t, label: n, error: e, children: [
    ...
    m && /* @__PURE__ */ B(Mn, { open: M, anchorEl: m, placement: "bottom-start", modifiers: [{
      name: "arrow",
      enabled: !0,
      options: {
        element: m
      ...
      l == null || l(Tt(L).format("YYYY-MM-DD")), N(Tt(L).format("DD.MM.YYYY")), E(!1);
    } }) }) })
  ] }) });
  ...
  const [h, p] = R.useState(""), [g, m] = R.useState(a), w = cs(h, 500), M = ls(r, i), {
    records: E,
    isLoading: b
  } = us({
    idField: i,
  ...
  return /* @__PURE__ */ B(mt, { children: /* @__PURE__ */ B(di, { ref: f, multiple: e, value: n, ...c, disabled: q || c.disabled, inputLoading: q, options: ee, idField: i, onOpen: () => m(!0), onClose: () => m(!1), isLoading: N.isLoading || b, valueLoading: b, popupAdditionalOptionsRenderer: H, open: g, afterItems: [(N.isLoading || N.isFetching || e && b) && /* @__PURE__ */ B("div", { children: /* @__PURE__ */ B(Ye, { icon: On.faCircleNotch, css: {
    ...
    e ? j == null || j.map((U) => {
      M(U);
    }) : M(j), (L = c.onSelect) == null || L.call(c, j);
  }, onInputChange: (j, L, U) => {
  ...
  replacement: n,
  showMask: r
}), /* @__PURE__ */ B(ht, { useTypograf: !1, ...t, ref: i })), Za = R.forwardRef(Ma);
export {
  Ba as B,
  ms as C,
  $a as D,
