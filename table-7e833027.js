import { r as j } from "./react-6f5a8403.js";
/**
   * table-core
   *
...
function m(e, o, t) {
  ...
  return (r) => {
    ...
    if (t.key && t.debug && (g = Date.now()), i = o(...u), t == null || t.onChange == null || t.onChange(i), t.key && t.debug && t != null && t.debug()) {
      const c = Math.round((Date.now() - l) * 100) / 100, S = Math.round((Date.now() - g) * 100) / 100, d = S / 16, a = (f, p) => {
        for (f = String(f); f.length < p; )
          f = " " + f;
        return f;
      };
      console.info(`%c⏱ ${a(S, 5)} /${a(c, 5)} ms`, `
            font-size: .6rem;
            font-weight: bold;
...
function Re(e, o, t, n) {
  ...
  let g = (i = (r = u.id) != null ? r : s ? s.replace(".", "_") : void 0) != null ? i : typeof u.header == "string" ? u.header : void 0, c;
  if (u.accessorFn ? c = u.accessorFn : s && (s.includes(".") ? c = (d) => {
    let a = d;
  ...
  let S = {
    ...
    getFlatColumns: m(() => [!0], () => {
      var d;
      return [S, ...(d = S.columns) == null ? void 0 : d.flatMap((a) => a.getFlatColumns())];
...
const we = {
  createTable: (e) => {
    e.getHeaderGroups = m(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left, e.getState().columnPinning.right], (o, t, n, i) => {
      var r, l;
      const u = (r = n == null ? void 0 : n.map((S) => t.find((d) => d.id === S)).filter(Boolean)) != null ? r : [], s = (l = i == null ? void 0 : i.map((S) => t.find((d) => d.id === S)).filter(Boolean)) != null ? l : [], g = t.filter((S) => !(n != null && n.includes(S.id)) && !(i != null && i.includes(S.id)));
      return D(o, [...u, ...g, ...s], e);
...
function D(e, o, t, n) {
  ...
  const u = function(d, a) {
    a === void 0 && (a = 1), l = Math.max(l, a), d.filter((f) => f.getIsVisible()).forEach((f) => {
      var p;
      (p = f.columns) != null && p.length && u(f.columns, a + 1);
    }, 0);
  };
  u(e);
  let s = [];
  const g = (d, a) => {
    ...
    d.forEach((w) => {
      ...
      let v, V = !1;
      if (_ && w.column.parent ? v = w.column.parent : (v = w.column, V = !0), R && (R == null ? void 0 : R.column) === v)
        R.subHeaders.push(w);
      else {
        const I = ne(t, v, {
          id: [n, a, v.id, w == null ? void 0 : w.id].filter(Boolean).join("_"),
          isPlaceholder: V,
          placeholderId: V ? `${p.filter((z) => z.column === v).length}` : void 0,
          depth: a,
          index: p.length
        });
        I.subHeaders.push(w), p.push(I);
      }
      f.headers.push(w), w.headerGroup = f;
    }), s.push(f), a > 0 && g(p, a - 1);
  }, c = o.map((d, a) => ne(t, d, {
    depth: l,
    index: a
  }));
  ...
  const S = (d) => d.filter((f) => f.column.getIsVisible()).map((f) => {
    let p = 0, w = 0, R = [0];
    f.subHeaders && f.subHeaders.length ? (R = [], S(f.subHeaders).forEach((v) => {
      let {
        colSpan: V,
        rowSpan: I
      } = v;
  ...
  return S((i = (r = s[0]) == null ? void 0 : r.headers) != null ? i : []), s;
}
const ve = (e, o, t, n, i, r, l) => {
  let u = {
    id: o,
    index: n,
    original: t,
    ...
    subRows: r ?? [],
    getLeafRows: () => me(u.subRows, (s) => s.subRows),
    ...
    getAllCells: m(() => [e.getAllLeafColumns()], (s) => s.map((g) => Ce(e, u, g, g.id)), C(e.options, "debugRows")),
    _getAllCellsByColumnId: m(() => [u.getAllCells()], (s) => s.reduce((g, c) => (g[c.column.id] = c, g), {}), C(e.options, "debugRows"))
  };
  ...
  createColumn: (e, o) => {
    e.getAutoFilterFn = () => {
      ...
      o.setColumnFilters((n) => {
        const i = e.getFilterFn(), r = n == null ? void 0 : n.find((c) => c.id === e.id), l = P(t, r ? r.value : void 0);
        if (oe(i, l, e)) {
          var u;
        ...
        if (r) {
          var g;
          return (g = n == null ? void 0 : n.map((c) => c.id === e.id ? s : c)) != null ? g : [];
        }
...
const Fe = (e, o, t) => t.reduce((n, i) => {
...
}, Ie = (e, o) => Array.from(new Set(o.map((t) => t.getValue(e))).values()), ye = (e, o) => new Set(o.map((t) => t.getValue(e))).size, Ee = (e, o) => o.length, L = {
  sum: Fe,
  min: $e,
  max: Me,
  extent: Ve,
  ...
  createColumn: (e, o) => {
    e.toggleGrouping = () => {
      ...
      if (!e)
        throw new Error();
      return A(e.columnDef.aggregationFn) ? e.columnDef.aggregationFn : e.columnDef.aggregationFn === "auto" ? e.getAutoAggregationFn() : (t = (n = o.options.aggregationFns) == null ? void 0 : n[e.columnDef.aggregationFn]) != null ? t : L[e.columnDef.aggregationFn];
    };
  },
  createTable: (e) => {
...
const He = {
  ...
  createColumn: (e, o) => {
    e.getIndex = m((t) => [E(o, t)], (t) => t.findIndex((n) => n.id === e.id), C(o.options, "debugColumns")), e.getIsFirstColumn = (t) => {
      var n;
    ...
    e.setColumnOrder = (o) => e.options.onColumnOrderChange == null ? void 0 : e.options.onColumnOrderChange(o), e.resetColumnOrder = (o) => {
      ...
      if (!(o != null && o.length))
        ...
        for (; u.length && l.length; ) {
          const s = l.shift(), g = u.findIndex((c) => c.id === s);
      ...
      o.setColumnPinning((i) => {
        ...
        if (t === "right") {
          ...
          return {
            ...
            right: [...((s = i == null ? void 0 : i.right) != null ? s : []).filter((S) => !(n != null && n.includes(S))), ...n]
          };
        }
        if (t === "left") {
          var g, c;
          return {
            left: [...((g = i == null ? void 0 : i.left) != null ? g : []).filter((S) => !(n != null && n.includes(S))), ...n],
  ...
  createColumn: (e, o) => {
    e.getSize = () => {
      ...
      return Math.min(Math.max((t = e.columnDef.minSize) != null ? t : G.minSize, (n = r ?? e.columnDef.size) != null ? n : G.size), (i = e.columnDef.maxSize) != null ? i : G.maxSize);
    }, e.getStart = m((t) => [t, E(o, t), o.getState().columnSizing], (t, n) => n.slice(0, e.getIndex(t)).reduce((i, r) => i + r.getSize(), 0), C(o.options, "debugColumns")), e.getAfter = m((t) => [t, E(o, t), o.getState().columnSizing], (t, n) => n.slice(e.getIndex(t) + 1).reduce((i, r) => i + r.getSize(), 0), C(o.options, "debugColumns")), e.resetSize = () => {
      o.setColumnSizing((t) => {
        let {
          [e.id]: n,
          ...i
    ...
    e.getSize = () => {
      ...
      return (r) => {
        if (!n || !i || (r.persist == null || r.persist(), T(r) && r.touches && r.touches.length > 1))
          return;
        const l = e.getSize(), u = e ? e.getLeafHeaders().map((R) => [R.column.id, R.column.getSize()]) : [[n.id, n.getSize()]], s = T(r) ? Math.round(r.touches[0].clientX) : r.clientX, g = {}, c = (R, _) => {
          typeof _ == "number" && (o.setColumnSizingInfo((v) => {
            var V, I;
            const z = o.options.columnResizeDirection === "rtl" ? -1 : 1, b = (_ - ((V = v == null ? void 0 : v.startOffset) != null ? V : 0)) * z, ee = Math.max(b / ((I = v == null ? void 0 : v.startSize) != null ? I : 0), -0.999999);
            return v.columnSizingStart.forEach((fe) => {
              let [pe, te] = fe;
        ...
        }, a = t || typeof document < "u" ? document : null, f = {
          moveHandler: (R) => S(R.clientX),
          upHandler: (R) => {
            a == null || a.removeEventListener("mousemove", f.moveHandler), a == null || a.removeEventListener("mouseup", f.upHandler), d(R.clientX);
          }
        }, p = {
          moveHandler: (R) => (R.cancelable && (R.preventDefault(), R.stopPropagation()), S(R.touches[0].clientX), !1),
          upHandler: (R) => {
            var _;
            a == null || a.removeEventListener("touchmove", p.moveHandler), a == null || a.removeEventListener("touchend", p.upHandler), R.cancelable && (R.preventDefault(), R.stopPropagation()), d((_ = R.touches[0]) == null ? void 0 : _.clientX);
          }
        }, w = Le() ? {
          passive: !1
        } : !1;
        T(r) ? (a == null || a.addEventListener("touchmove", p.moveHandler, w), a == null || a.addEventListener("touchend", p.upHandler, w)) : (a == null || a.addEventListener("mousemove", f.moveHandler, w), a == null || a.addEventListener("mouseup", f.upHandler, w)), o.setColumnSizingInfo((R) => ({
          ...R,
          startOffset: s,
          startSize: l,
          deltaOffset: 0,
...
const Be = {
  ...
  createTable: (e) => {
    e.getGlobalAutoFilterFn = () => M.includesString, e.getGlobalFilterFn = () => {
      ...
      return A(n) ? n : n === "auto" ? e.getGlobalAutoFilterFn() : (o = (t = e.options.filterFns) == null ? void 0 : t[n]) != null ? o : M[n];
    }, e.setGlobalFilter = (o) => {
      ...
      o.setRowPinning((s) => {
        ...
        if (t === "bottom") {
          ...
          return {
            ...
            bottom: [...((d = s == null ? void 0 : s.bottom) != null ? d : []).filter((p) => !(u != null && u.has(p))), ...Array.from(u)]
          };
        }
        if (t === "top") {
          var a, f;
          return {
            ...
            bottom: ((f = s == null ? void 0 : s.bottom) != null ? f : []).filter((p) => !(u != null && u.has(p)))
          };
        }
        return {
  ...
  createTable: (e) => {
    ...
    }, C(e.options, "debugRows")), e.getTopRows = () => e._getPinnedRows("top"), e.getBottomRows = () => e._getPinnedRows("bottom"), e.getCenterRows = m(() => [e.getRowModel().rows, e.getState().rowPinning.top, e.getState().rowPinning.bottom], (o, t, n) => {
  ...
  createTable: (e) => {
    ...
    }), e.getPreSelectedRowModel = () => e.getCoreRowModel(), e.getSelectedRowModel = m(() => [e.getState().rowSelection, e.getCoreRowModel()], (o, t) => Object.keys(o).length ? N(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, C(e.options, "debugTable")), e.getFilteredSelectedRowModel = m(() => [e.getState().rowSelection, e.getFilteredRowModel()], (o, t) => Object.keys(o).length ? N(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, C(e.options, "debugTable")), e.getGroupedSelectedRowModel = m(() => [e.getState().rowSelection, e.getSortedRowModel()], (o, t) => Object.keys(o).length ? N(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
...
function N(e, o) {
  const t = e.getState().rowSelection, n = [], i = {}, r = function(l, u) {
    return l.map((s) => {
      var g;
      const c = Y(s, t);
      if (c && (n.push(s), i[s.id] = s), (g = s.subRows) != null && g.length && (s = {
        ...s,
        subRows: r(s.subRows)
      }), c)
        return s;
...
const Q = /([0-9]+)/gm, Ue = (e, o, t) => ce(x(e.getValue(t)).toLowerCase(), x(o.getValue(t)).toLowerCase()), Xe = (e, o, t) => ce(x(e.getValue(t)), x(o.getValue(t))), Ke = (e, o, t) => Z(x(e.getValue(t)).toLowerCase(), x(o.getValue(t)).toLowerCase()), Je = (e, o, t) => Z(x(e.getValue(t)), x(o.getValue(t))), Qe = (e, o, t) => {
  ...
  createColumn: (e, o) => {
    e.getAutoSortingFn = () => {
      ...
      o.setSorting((l) => {
        ...
        let g = [], c, S = r ? t : i === "desc";
        if (l != null && l.length && e.getCanMultiSort() && n ? u ? c = "toggle" : c = "add" : l != null && l.length && s !== l.length - 1 ? c = "replace" : u ? c = "toggle" : c = "replace", c === "toggle" && (r || i || (c = "remove")), c === "add") {
          var d;
          g = [...l, {
            id: e.id,
            desc: S
...
function be(e) {
  ...
  i._features.forEach((d) => {
    var a;
    s = (a = d.getInitialState == null ? void 0 : d.getInitialState(s)) != null ? a : s;
  });
  const g = [];
  let c = !1;
  const S = {
    ...
    _getRowId: (d, a, f) => {
      var p;
      return (p = i.options.getRowId == null ? void 0 : i.options.getRowId(d, a, f)) != null ? p : `${f ? [f.id, a].join(".") : a}`;
    },
    ...
    getRow: (d, a) => {
      let f = (a ? i.getPrePaginationRowModel() : i.getRowModel()).rowsById[d];
    ...
    getAllColumns: m(() => [i._getColumnDefs()], (d) => {
      const a = function(f, p, w) {
        return w === void 0 && (w = 0), f.map((R) => {
          const _ = Re(i, R, w, p), v = R;
          return _.columns = v.columns ? a(v.columns, _, w + 1) : [], _;
        });
      };
      return a(d);
    }, C(e, "debugColumns")),
    getAllFlatColumns: m(() => [i.getAllColumns()], (d) => d.flatMap((a) => a.getFlatColumns()), C(e, "debugColumns")),
    _getAllFlatColumnsById: m(() => [i.getAllFlatColumns()], (d) => d.reduce((a, f) => (a[f.id] = f, a), {}), C(e, "debugColumns")),
    getAllLeafColumns: m(() => [i.getAllColumns(), i._getOrderColumnsFn()], (d, a) => {
  ...
  return (e) => m(() => [e.options.data], (o) => {
    const t = {
      ...
      for (let g = 0; g < i.length; g++) {
        const c = ve(e, e._getRowId(i[g], g, l), i[g], g, r, void 0, l == null ? void 0 : l.id);
        if (t.flatRows.push(c), t.rowsById[c.id] = c, u.push(c), e.options.getSubRows) {
          var s;
          c.originalSubRows = e.options.getSubRows(i[g], g), (s = c.originalSubRows) != null && s.length && (c.subRows = n(c.originalSubRows, r + 1, c));
        }
      }
      return u;
    };
...
/**
   ...
   */
function rt(e, o) {
  return e ? et(e) ? /* @__PURE__ */ j.createElement(e, o) : e : null;
}
function et(e) {
  return tt(e) || typeof e == "function" || nt(e);
}
function tt(e) {
