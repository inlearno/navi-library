...
const ww = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-606e458d.js"),
  windowOptions: {
    icon: Qu.faUsers,
    title: "Пользователи",
    width: 800
  ...
  id: "user-profile",
  path: "/user-profile",
  component: () => import("./UserProfile-3bf94aed.js"),
  windowOptions: {
    icon: Dd.faUserGear,
    title: "Профиль",
    width: 400,
...
const _w = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-a2f3b96c.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-64d91c85.js"),
  privilege: "ProgramDocsView",
  windowOptions: {
  ...
  component: () => import("./Draft-3a051637.js"),
  ...
  component: () => import("./CopyProgramForm-222abe16.js"),
  windowOptions: {
  ...
  component: () => import("./Dictionaries-e545f832.js"),
  windowOptions: {
    title: "Справочники",
    width: 700,
    height: 500,
