...
const ww = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-390a4ce8.js"),
  windowOptions: {
    icon: Qu.faUsers,
    title: "Пользователи",
    width: 800
  ...
  id: "user-profile",
  path: "/user-profile",
  component: () => import("./UserProfile-5edec089.js"),
  windowOptions: {
    icon: Dd.faUserGear,
    title: "Профиль",
    width: 400,
...
const _w = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-562a1ad0.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-72f3f7ab.js"),
  privilege: "ProgramDocsView",
  windowOptions: {
  ...
  component: () => import("./Draft-bd26be03.js"),
  ...
  component: () => import("./CopyProgramForm-46d54b5d.js"),
  windowOptions: {
  ...
  component: () => import("./Dictionaries-4216f730.js"),
  windowOptions: {
    title: "Справочники",
    width: 700,
    height: 500,
