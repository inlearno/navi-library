import { b as v, j as n, F as _ } from "./library-edebc13d.js";
import { F as S } from "./icons-ad9f8a73.js";
import { a as j, P as V } from "./DictionaryCell-0ed6c265.js";
import { S as X, d as Y, R as q, T as G, e as J, A as K, f as Z, C as ee, g as te, F as re, h as ie, M as oe, i as ne, a as se, j as le, I as ae, k as de, D as ce, l as ue, b as pe, m as me, c as fe, n as he, B as ge, o as ye } from "./BookInput-2bdb544c.js";
import { r as f, d as N, g as ve } from "./react-6f5a8403.js";
import { u as Fe, T as be, c as xe } from "./index-e4b74cf0.js";
import { M as $, f as we } from "./ConstructorForm-350da3a4.js";
import { B as P, g as Te, b as Ce, F as Ie, u as _e } from "./Phone-e554deed.js";
import { u as U } from "./useResetHttpQueryCache-06de9764.js";
import { P as Ee, a as Pe, A as ke, I as M } from "./mui-d84d21b5.js";
import { f as De } from "./faPlus-da331287.js";
import { f as Se } from "./faPenAlt-38421783.js";
import "./configureQueriedCombo-f390ded5.js";
...
function ze({
  ...
  const [a, p] = f.useState(Re), u = f.useCallback((s) => {
    d.current && p(s);
    ...
    const R = i == null ? void 0 : i.clientX, z = i == null ? void 0 : i.clientY, Q = typeof R == "number" && typeof z == "number" ? {
      left: R,
      top: z
    } : void 0, B = (y) => {
      if (!s && !y.setAnchorElUsed && r !== "dialog" && Me("missingEventOrAnchorEl", "eventOrAnchorEl should be defined if setAnchorEl is not used"), e) {
        if (!e.isOpen)
          return y;
    ...
    u((y) => y._deferNextOpen ? (setTimeout(() => u(B), 0), {
      ...y,
      _deferNextOpen: !1
    }) : B(y));
  }), F = (s) => {
...
const Le = ({
  ...
  return /* @__PURE__ */ v(_, { children: [
    /* @__PURE__ */ n(Le, { onConfirm: () => {
      g();
    }, children: (m) => /* @__PURE__ */ n(M, { size: "small", css: [{
      padding: "4px",
      fontSize: "0.75rem",
      lineHeight: "1rem",
      "--tw-text-opacity": "1",
    ...
    }], ...m, children: /* @__PURE__ */ n(S, { icon: we.faTrash }) }) }),
  ...
  return /* @__PURE__ */ v(_, { children: [
    /* @__PURE__ */ n(M, { size: "small", onClick: () => d(!0), children: /* @__PURE__ */ n(S, { icon: De.faPlus }) }),
...
var Oe = O.exports;
const Qe = /* @__PURE__ */ ve(Oe), o = xe(), L = [{
  id: "results",
  ...
  return /* @__PURE__ */ n(j, { fit: !0, header: /* @__PURE__ */ n(Ue, { title: r, onSave: () => h(e), form: t }), footer: /* @__PURE__ */ n(V, { table: g }), children: /* @__PURE__ */ n(be, { table: g }) });
}, ct = () => {
