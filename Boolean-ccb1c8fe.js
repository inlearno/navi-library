import { I as Rn, b as De, j, f as Fr, F as tt, J as Tn, G as Mn, l as kn } from "./library-6ace56c9.js";
...
import { f as Un } from "./faEye-6ff4b96e.js";
import { c as $n, f as Yn, e as Xn, h as lt, d as qn, b as Gn } from "./DictionaryCell-9553281c.js";
const Qn = (e, n = "id") => {
  const r = Rn();
  return (t) => {
...
const $t = (e) => Array.isArray(e) ? e.length === 0 : !e, Go = ({
  ...
  return /* @__PURE__ */ j(
    xn,
    {
      ...
      open: a,
      value: r,
      isLoading: u.isLoading || i.isLoading,
      onOpen: () => {
        s(!0);
      },
      onClose: () => {
