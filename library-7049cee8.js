...
const ww = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-72a7f2bb.js"),
  windowOptions: {
    icon: Qu.faUsers,
    title: "Пользователи",
    width: 800
  ...
  id: "user-profile",
  path: "/user-profile",
  component: () => import("./UserProfile-6f276764.js"),
  windowOptions: {
    icon: Dd.faUserGear,
    title: "Профиль",
    width: 400,
...
const _w = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-ea0a2aa4.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-1ac7dc89.js"),
  privilege: "ProgramDocsView",
  windowOptions: {
  ...
  component: () => import("./Draft-91e43394.js"),
  ...
  privilege: "ProgramDocsEdit",
  component: () => import("./CopyProgramForm-22bcd916.js"),
  windowOptions: {
  ...
  privilege: "ProgramDocsView",
  component: () => import("./Dictionaries-31cf10f7.js"),
  windowOptions: {
    title: "Справочники",
    width: 700,
    height: 500,
