...
import { J as xn, L as bt, O as mi, P as bi, T as Ur, V as wi, I as Gt, W as Si, X as xi, l as vt, Q as _i, b as Ee, j as B, Y as Oi, f as _n, F as yt, Z as Di, G as Ei } from "./library-b46aabc8.js";
import { r as R, R as ne, e as Ri, c as Ht, g as On } from "./react-6f5a8403.js";
import { Q as Dn, d as zi, e as Pi, g as Ti, i as Mi, j as Ci, s as $r, k as qr, w as ki, l as Ai, m as Ni, u as En, c as Fi, f as Li, n as Wi, h as Mt, b as Bi } from "./DictionaryCell-43b9ac3c.js";
import { F as Ye, p as Rn } from "./icons-ad9f8a73.js";
import { B as ji, A as Vi, g as Hi, i as Ii, a as zr, k as Ui, u as zn, P as Pn, l as $i, I as qi, f as Yi, j as Xi, C as Qi, m as Yr, o as Ki } from "./mui-2ff488a7.js";
import { f as Gi } from "./faEye-ea161ce6.js";
function Xr(e, n) {
...
var et, lt, ct, Pe, xt, ft, dt, Wt, _t, gr, Ot, vr, Dt, yr, Et, mr, wn, Zi = (wn = class extends xn {
  constructor(n, r, t) {
    super();
    fe(this, dt);
    fe(this, _t);
  ...
  const r = Q(this, Pe), t = new Map(
    ...
    const d = Q(this, et).defaultQueryOptions(h);
    return Q(this, Pe).find(
      (m) => m.options.queryHash === d.queryHash
    ) ?? new Dn(Q(this, et), d);
  }, c = a.map((h) => ({
    defaultedQueryOptions: h,
    observer: l(h)
  })), f = (h, d) => i.indexOf(h.defaultedQueryOptions) - i.indexOf(d.defaultedQueryOptions);
  return s.concat(c).sort(f);
}, Dt = new WeakSet(), yr = function(n, r) {
  const t = Q(this, Pe).indexOf(n);
  t !== -1 && (ge(this, dt, Wt).call(this, Ji(Q(this, lt), t, r)), ge(this, Et, mr).call(this));
...
}, wn), Ke, Ge, Te, qe, pt, Bt, Rt, br, Sn, es = (Sn = class extends xn {
  constructor(n, r) {
    super();
    fe(this, pt);
    fe(this, Rt);
...
function ts({
  ...
  const t = Gt(r), i = zi(), s = Pi(), o = R.useMemo(
    () => e.map((m) => {
...
function rs(e, n) {
  ...
  const i = R.useSyncExternalStore(
    ...
    (o, a) => {
      t.mutate(o, a).catch(ns);
    },
    [t]
  );
  if (i.error && Ni(t.options.throwOnError, [i.error]))
    throw i.error;
...
function Na(e, n, r) {
  ...
  return rs({
    ...c,
    mutationFn: async (d) => {
      const g = i(vt.pick(d, ...s)), m = vt.omit(d, ...s), w = vt.isEmpty(m) ? void 0 : a ? {
        data: m
      } : m, {
        data: T
      } = await o.request({
    ...
    onSuccess: (d, g, m) => {
      ...
      (w = c.onSuccess) == null || w.call(c, d, g, m);
    },
    onError: (d) => {
      if (d.response) {
        const {
        ...
        g === 403 && _i.error("Операция для данного пользователя запрещена", {
          position: "top-center"
        });
      }
    }
...
const Qr = () => {
  ...
  return { fetch: (c) => {
    ...
    const h = () => {
      const d = s.seq, g = e.fetcher([...s.batch]), m = s.currentRequest;
      return i == null || i.fetch({ seq: d, batch: [...s.batch] }), o(), g.then((w) => {
        i == null || i.data({ seq: d, data: w }), m.resolve(w);
      }).catch((w) => {
        i == null || i.error({ seq: d, error: w }), m.reject(w);
      }), s.seq++, g;
    };
    if (f === "immediate") {
      const d = s.currentRequest;
      return h(), d.value.then((g) => e.resolver(g, c));
    } else
      return f === "never" ? s.currentRequest.value.then((d) => e.resolver(d, c)) : (s.timer = setTimeout(h, f), s.currentRequest.value.then((d) => e.resolver(d, c)));
  } };
}, ss = (e) => (n, r) => n.find((t) => t[e] == r), Tn = (e) => (n, r) => {
  const t = r - n;
  return e - t;
}, os = ({
  url: e,
  ...
  let a = /* @__PURE__ */ Ee(ji, { className: n, size: s || "small", css: {
    display: "flex",
  ...
  return r && (a = /* @__PURE__ */ B(Oi, { title: r, arrow: !0, children: a })), a;
};
function ls(e, n) {
...
const cs = ({
  ...
  return /* @__PURE__ */ Ee("form", { className: n, onSubmit: r.onSubmit, children: [
    t.root && /* @__PURE__ */ Ee(Vi, { severity: "error", children: [
      ((i = t.root.error) == null ? void 0 : i.message) && /* @__PURE__ */ B(Hi, { css: [{
        fontSize: "0.875rem",
        lineHeight: "1.25rem"
      }, !t.root.fields && {
        margin: "0px"
...
var le = (e) => !xe(e) && !Array.isArray(e) && Mn(e) && !ot(e), Cn = (e) => le(e) && e.target ? zt(e.target) ? e.target.checked : e.target.value : e, fs = (e) => e.substring(0, e.search(/\.\d+(\.|$)/)) || e, kn = (e, n) => e.has(fs(n)), ds = (e) => {
...
const It = {
  ...
  required: "required",
  validate: "validate"
}, ps = ne.createContext(null), Tr = () => ne.useContext(ps);
var An = (e, n, r, t = !0) => {
  const i = {
...
function vs(e) {
  const n = Tr(), { name: r, disabled: t, control: i = n.control, shouldUnregister: s } = e, o = kn(i._names.array, r), a = gs({
    control: i,
    name: r,
  ...
  return ne.useEffect(() => {
    const f = i._options.shouldUnregister || s, h = (d, g) => {
      const m = P(i._fields, d);
      m && (m._f.mount = g);
    };
    if (h(r, !0), f) {
      const d = De(P(i._options.defaultValues, r));
      re(i._defaultValues, r, d), oe(P(i._formValues, r)) && re(i._formValues, r, d);
    }
    return () => {
    ...
    field: {
      ...
      ref: (f) => {
        ...
        h && f && (h._f.ref = {
          focus: () => f.focus(),
          select: () => f.select(),
          setCustomValidity: (d) => f.setCustomValidity(d),
...
var it = (e) => le(e) && !$t(e) ? e : {
  ...
  const { ref: s, refs: o, required: a, maxLength: l, minLength: c, min: f, max: h, pattern: d, validate: g, name: m, valueAsNumber: w, mount: T, disabled: E } = e._f, b = P(n, m);
  if (!T || E)
    return {};
  const M = o ? o[0] : s, A = (C) => {
...
function ve(e, n) {
  const r = Array.isArray(n) ? n : Cr(n) ? [n] : Wn(n), t = r.length === 1 ? e : bs(e, r), i = r.length - 1, s = r[i];
  return t && delete t[s], i !== 0 && (le(t) && Ae(t) || Array.isArray(t) && ws(t)) && ve(e, r.slice(0, -1)), e;
}
var ar = () => {
  let e = [];
  return {
...
var Hn = (e) => e.type === "select-multiple", Ss = (e) => Ar(e) || zt(e), ur = (e) => Ut(e) && e.isConnected, In = (e) => {
  for (const n in e)
    if (Je(e[n]))
      return !0;
  return !1;
...
}, ht = (e) => oe(e) ? e : $t(e) ? e.source : le(e) ? $t(e.value) ? e.value.source : e.value : e, _s = (e) => e.mount && (e.required || e.min || e.max || e.maxLength || e.minLength || e.pattern || e.validate);
function nn(e, n, r) {
  const t = P(e, r);
  if (t || Cr(r))
    return {
...
var Os = (e, n, r, t, i) => i.isOnAll ? !1 : !r && i.isOnTouch ? !(n || e) : (r ? t.isOnBlur : i.isOnBlur) ? !e : (r ? t.isOnChange : i.isOnChange) ? e : !0, Ds = (e, n) => !Pt(P(e, n)).length && ve(e, n);
const Es = {
  mode: We.onSubmit,
...
function Rs(e = {}, n) {
  ...
  const h = {
    ...
    array: ar(),
    state: ar()
  }, g = Kr(r.mode), m = Kr(r.reValidateMode), w = r.criteriaMode === We.all, T = (u) => (p) => {
    clearTimeout(f), f = setTimeout(u, p);
  }, E = async (u) => {
    if (h.isValid || u) {
      const p = r.resolver ? Ae((await j()).errors) : await U(i, !0);
      p !== t.isValid && d.state.next({
        isValid: p
      });
    }
  }, b = (u) => h.isValidating && d.state.next({
    isValidating: u
  }), M = (u, p = [], v, k, z = !0, _ = !0) => {
    if (k && v) {
      ...
      if (_ && Array.isArray(P(t.errors, u))) {
        ...
        z && re(t.errors, u, V), Ds(t.errors, u);
      }
      ...
      h.dirtyFields && (t.dirtyFields = Ct(s, o)), d.state.next({
        name: u,
        isDirty: F(u, p),
    ...
    if (z) {
      ...
      oe(_) || k && k.defaultChecked || p ? re(o, u, p ? _ : lr(z._f)) : G(u, _), a.mount && E();
    }
  }, q = (u, p, v, k, z) => {
    let _ = !1, V = !1;
    const se = {
    ...
    return _ && z && d.state.next(se), _ ? se : {};
  }, H = (u, p, v, k) => {
    const z = P(t.errors, u), _ = h.isValid && Le(p) && t.isValid !== p;
    ...
    b(!1);
  }, j = async (u) => r.resolver(o, r.context, xs(u || l.mount, i, r.criteriaMode, r.shouldUseNativeValidation)), L = async (u) => {
    const { errors: p } = await j(u);
    if (u)
      for (const v of u) {
        const k = P(p, v);
    ...
    for (const k in u) {
      ...
      if (z) {
        const { _f: _, ...V } = z;
        if (_) {
          const se = l.array.has(_.name), ce = await rn(z, o, w, r.shouldUseNativeValidation && !p, se);
          if (ce[_.name] && (v.valid = !1, p))
            break;
          !p && (P(ce, _.name) ? se ? ms(t.errors, ce, _.name) : re(t.errors, _.name, ce[_.name]) : ve(t.errors, _.name));
        }
        V && await U(V, p, v);
      }
    }
    ...
    for (const u of l.unMount) {
      const p = P(i, u);
      p && (p._f.refs ? p._f.refs.every((v) => !ur(v)) : !ur(p._f.ref)) && W(u);
    }
    l.unMount = /* @__PURE__ */ new Set();
  }, F = (u, p) => (u && p && re(o, u, p), !Ze(y(), s)), X = (u, p, v) => Ln(u, l, {
    ...a.mount ? o : oe(p) ? s : He(u) ? { [u]: p } : p
  }, v, p), J = (u) => Pt(P(a.mount ? o : s, u, e.shouldUnregister ? P(s, u, []) : [])), G = (u, p, v = {}) => {
    const k = P(i, u);
    let z = p;
    if (k) {
      const _ = k._f;
      _ && (!_.disabled && re(o, u, $n(p, _)), z = Ut(_.ref) && xe(p) ? "" : p, Hn(_.ref) ? [..._.ref.options].forEach((V) => V.selected = z.includes(V.value)) : _.refs ? zt(_.ref) ? _.refs.length > 1 ? _.refs.forEach((V) => (!V.defaultChecked || !V.disabled) && (V.checked = Array.isArray(z) ? !!z.find((se) => se === V.value) : z === V.value)) : _.refs[0] && (_.refs[0].checked = !!z) : _.refs.forEach((V) => V.checked = V.value === z) : kr(_.ref) ? _.ref.value = "" : (_.ref.value = z, _.ref.type || d.values.next({
        name: u,
        values: { ...o }
      })));
    }
    ...
    for (const k in p) {
      const z = p[k], _ = `${u}.${k}`, V = P(i, _);
      (l.array.has(u) || !qt(z) || V && !V._f) && !ot(z) ? K(_, z, v) : G(_, z, v);
    }
  }, Z = (u, p, v = {}) => {
    const k = P(i, u), z = l.array.has(u), _ = De(p);
    re(o, u, _), z ? (d.array.next({
      name: u,
      values: { ...o }
    }), (h.isDirty || h.dirtyFields) && v.shouldDirty && d.state.next({
      name: u,
      dirtyFields: Ct(s, o),
      isDirty: F(u, _)
    })) : k && !k._f && !xe(_) ? K(u, _, v) : G(u, _, v), Gr(u, l) && d.state.next({ ...t }), d.values.next({
      name: u,
      values: { ...o }
    }), !a.mount && n();
  }, te = async (u) => {
    const p = u.target;
    let v = p.name, k = !0;
    const z = P(i, v), _ = () => p.type ? lr(z._f) : Cn(u), V = (se) => {
      k = Number.isNaN(se) || se === P(o, v, se);
    };
    if (z) {
      let se, ce;
      const je = _(), nt = u.type === It.BLUR || u.type === It.FOCUS_OUT, gi = !_s(z._f) && !r.resolver && !P(t.errors, v) && !z._f.deps || Os(nt, P(t.touchedFields, v), t.isSubmitted, m, g), ir = Gr(v, l, nt);
      ...
      if (!nt && d.values.next({
        ...
        return h.isValid && E(), vi && d.state.next({ name: v, ...ir ? {} : sr });
      if (!nt && ir && d.state.next({ ...t }), b(!0), r.resolver) {
    ...
    return d.state.next({
      ...
      errors: t.errors,
      isValidating: !1
    }), p.shouldFocus && !k && mt(i, ie, u ? z : l.mount), k;
  }, y = (u) => {
    const p = {
      ...s,
      ...a.mount ? o : {}
    };
    return oe(u) ? p : He(u) ? P(p, u) : u.map((v) => P(p, v));
  }, S = (u, p) => ({
    invalid: !!P((p || t).errors, u),
    isDirty: !!P((p || t).dirtyFields, u),
    isTouched: !!P((p || t).touchedFields, u),
    error: P((p || t).errors, u)
  }), x = (u) => {
    u && jt(u).forEach((p) => ve(t.errors, p)), d.state.next({
      errors: u ? t.errors : {}
    });
  }, O = (u, p, v) => {
  ...
  }, D = (u, p) => Je(u) ? d.values.subscribe({
    next: (v) => u(X(void 0, p), v)
  }) : X(u, p, !0), W = (u, p = {}) => {
    for (const v of u ? jt(u) : l.mount)
      l.mount.delete(v), l.array.delete(v), p.keepValue || (ve(i, v), ve(o, v)), !p.keepError && ve(t.errors, v), !p.keepDirty && ve(t.dirtyFields, v), !p.keepTouched && ve(t.touchedFields, v), !r.shouldUnregister && !p.keepDefaultValue && ve(s, v);
    d.values.next({
      values: { ...o }
    }), d.state.next({
      ...t,
      ...p.keepDirty ? { isDirty: F() } : {}
    }), !p.keepIsValid && E();
  }, $ = ({ disabled: u, name: p, field: v, fields: k, value: z }) => {
    if (Le(u)) {
      const _ = u ? void 0 : oe(z) ? lr(v ? v._f : P(k, p)._f) : z;
      re(o, p, _), q(p, _, !1, !1, !0);
    }
  }, I = (u, p = {}) => {
    let v = P(i, u);
    const k = Le(p.disabled);
    return re(i, u, {
      ...v || {},
      _f: {
      ...
      ...r.progressive ? {
        ...
        min: ht(p.min),
        max: ht(p.max),
        minLength: ht(p.minLength),
        maxLength: ht(p.maxLength),
        pattern: ht(p.pattern)
      } : {},
      name: u,
      onChange: te,
      onBlur: te,
      ref: (z) => {
        if (z) {
          I(u, p), v = P(i, u);
          const _ = oe(z.value) && z.querySelectorAll && z.querySelectorAll("input,select,textarea")[0] || z, V = Ss(_), se = v._f.refs || [];
          ...
          v = P(i, u, {}), v._f && (v._f.mount = !1), (r.shouldUnregister || p.shouldUnregister) && !(kn(l.array, u) && a.action) && l.unMount.add(u);
      }
    };
  }, Y = () => r.shouldFocusError && mt(i, ie, l.mount), be = (u) => {
    Le(u) && (d.state.next({ disabled: u }), mt(i, (p, v) => {
      let k = u;
      const z = P(i, v);
      z && Le(z._f.disabled) && (k || (k = z._f.disabled)), p.disabled = k;
    }, 0, !1));
  }, he = (u, p) => async (v) => {
    let k;
    ...
    if (ve(t.errors, "root"), Ae(t.errors)) {
      ...
      p && await p({ ...t.errors }, v), Y(), setTimeout(Y);
    if (d.state.next({
      isSubmitted: !0,
      isSubmitting: !1,
    ...
    P(i, u) && (oe(p.defaultValue) ? Z(u, De(P(s, u))) : (Z(u, p.defaultValue), re(s, u, De(p.defaultValue))), p.keepTouched || ve(t.touchedFields, u), p.keepDirty || (ve(t.dirtyFields, u), t.isDirty = p.defaultValue ? F(u, De(P(s, u))) : F()), p.keepError || (ve(t.errors, u), h.isValid && E()), d.state.next({ ...t }));
  }, _e = (u, p = {}) => {
    const v = u ? De(u) : s, k = De(v), z = u && !Ae(u) ? k : s;
    if (p.keepDefaultValues || (s = v), !p.keepValues) {
      ...
      o = e.shouldUnregister ? p.keepDefaultValues ? De(s) : {} : De(z), d.array.next({
        values: { ...z }
      }), d.values.next({
        values: { ...z }
      });
    ...
    l = {
      ...
      watchAll: !1,
      focus: ""
    }, !a.mount && n(), a.mount = !h.isValid || !!p.keepIsValid || !!p.keepDirtyValues, a.watch = !!e.shouldUnregister, d.state.next({
      submitCount: p.keepSubmitCount ? t.submitCount : 0,
      isDirty: p.keepDirty ? t.isDirty : !!(p.keepDefaultValues && !Ze(u, s)),
      isSubmitted: p.keepIsSubmitted ? t.isSubmitted : !1,
      dirtyFields: p.keepDirtyValues ? p.keepDefaultValues && o ? Ct(s, o) : t.dirtyFields : p.keepDefaultValues && u ? Ct(s, u) : {},
  ...
  return {
    control: {
      ...
      _resetDefaultValues: () => Je(r.defaultValues) && r.defaultValues().then((u) => {
        Ce(u, r.resetOptions), d.state.next({
          isLoading: !1
        });
      }),
      _updateFormState: (u) => {
    ...
    setFocus: (u, p = {}) => {
      ...
      if (k) {
        ...
        z.focus && (z.focus(), p.shouldSelect && z.select());
      }
    },
    getFieldState: S
  };
    ...
    try {
      return Promise.resolve(function(o, a) {
        ...
        if (function(a) {
          ...
          return { values: {}, errors: Ms(ks(o.errors, !s.shouldUseNativeValidation && s.criteriaMode === "all"), s) };
        throw o;
      }));
    } catch (o) {
...
const Fs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  clsx: on,
  default: on
}, Symbol.toStringTag, { value: "Module" })), Ls = /* @__PURE__ */ Ri(Fs);
var ae = {}, Ie = {};
...
function Jn(e, n) {
  return n ? "".concat(n).concat(Us(e)) : e;
}
function Is(e, n) {
...
ae.addClassName = ni;
ae.addEvent = Xs;
ae.addUserSelectStyles = so;
ae.createCSSTransform = to;
ae.createSVGTransform = ro;
ae.getTouch = no;
ae.getTouchIdentifier = io;
ae.getTranslation = Nr;
ae.innerHeight = Js;
ae.innerWidth = Zs;
ae.matchesSelector = ri;
ae.matchesSelectorAndParentsTo = Ys;
ae.offsetXYFromParent = eo;
ae.outerHeight = Ks;
ae.outerWidth = Gs;
ae.removeClassName = ii;
ae.removeEvent = Qs;
ae.removeUserSelectStyles = oo;
var Me = Ie, an = qs(tt);
function Zn(e) {
...
Ue.canDragX = lo;
Ue.canDragY = co;
Ue.createCoreData = po;
Ue.createDraggableData = ho;
Ue.getBoundPosition = ao;
Ue.getControlPosition = fo;
Ue.snapToGrid = uo;
var ze = Ie, at = ae;
function ao(e, n, r) {
  if (!e.props.bounds)
...
er.default = void 0;
var fr = mo(R), Re = Lr(Rn), yo = Lr(Ht), ye = ae, Xe = Ue, dr = Ie, gt = Lr(tr);
function Lr(e) {
...
var Fe = {
  ...
  function r() {
    ...
    return t = n.call.apply(n, [this].concat(s)), ke(me(t), "state", {
      ...
      if (!(t.props.disabled || !(a.target instanceof c.defaultView.Node) || t.props.handle && !(0, ye.matchesSelectorAndParentsTo)(a.target, t.props.handle, l) || t.props.cancel && (0, ye.matchesSelectorAndParentsTo)(a.target, t.props.cancel, l))) {
        ...
        if (h != null) {
          var d = h.x, g = h.y, m = (0, Xe.createCoreData)(me(t), d, g);
      ...
      if (l != null) {
        ...
        if (Array.isArray(t.props.grid)) {
          var h = c - t.state.lastX, d = f - t.state.lastY, g = (0, Xe.snapToGrid)(t.props.grid, h, d), m = ln(g, 2);
          if (h = m[0], d = m[1], !h && !d)
            return;
          c = t.state.lastX + h, f = t.state.lastY + d;
        }
      ...
      if (t.state.dragging) {
        ...
        if (l != null) {
          var c = l.x, f = l.y;
          if (Array.isArray(t.props.grid)) {
            var h = c - t.state.lastX || 0, d = f - t.state.lastY || 0, g = (0, Xe.snapToGrid)(t.props.grid, h, d), m = ln(g, 2);
            h = m[0], d = m[1], c = t.state.lastX + h, f = t.state.lastY + d;
          }
  ...
  return Oo(r, [{
    ...
    value: function() {
      var i, s, o;
      return (i = this.props) !== null && i !== void 0 && i.nodeRef ? (s = this.props) === null || s === void 0 || (o = s.nodeRef) === null || o === void 0 ? void 0 : o.current : yo.default.findDOMNode(this);
    }
  }, {
    key: "render",
    value: function() {
...
(function(e) {
  ...
  var r = m(R), t = d(Rn), i = d(Ht), s = d(Ls), o = ae, a = Ue, l = Ie, c = d(er), f = d(tr), h = ["axis", "bounds", "children", "defaultPosition", "defaultClassName", "defaultClassNameDragging", "defaultClassNameDragged", "position", "positionOffset", "scale"];
  function d(y) {
  ...
  var pe = /* @__PURE__ */ function(y) {
    ...
    return C(x, [{
      ...
      value: function() {
        ...
        W.scale;
        var Ce = T(W, h), Be = {}, Se = null, Ne = !!we, u = !Ne || this.state.dragging, p = we || I, v = {
          // Set left if horizontal drag is enabled
          x: (0, a.canDragX)(this) && u ? this.state.x : p.x,
          // Set top if vertical drag is enabled
          y: (0, a.canDragY)(this) && u ? this.state.y : p.y
        };
...
var oi = Qn, ai = oi.default, Po = oi.DraggableCore;
Zt.exports = ai;
Zt.exports.default = ai;
Zt.exports.DraggableCore = Po;
var To = Zt.exports;
const Mo = /* @__PURE__ */ On(To);
var Co = globalThis && globalThis.__extends || function() {
  ...
  function(e) {
    ...
    return n.prototype.render = function() {
      return R.createElement("div", { className: this.props.className || "", style: Kt(Kt({ position: "absolute", userSelect: "none" }, ko[this.props.direction]), this.props.replaceStyles || {}), onMouseDown: this.onMouseDown, onTouchStart: this.onTouchStart }, this.props.children);
    }, n;
  }(R.PureComponent)
), Wr = { exports: {} };
function No(e, n) {
  var r = n && n.cache ? n.cache : Vo, t = n && n.serializer ? n.serializer : jo, i = n && n.strategy ? n.strategy : Lo;
  return i(e, {
    cache: r,
    serializer: t
  });
...
var Ho = Wr.exports;
const rt = /* @__PURE__ */ On(Ho);
var Io = globalThis && globalThis.__extends || function() {
  var e = function(n, r) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t, i) {
      t.__proto__ = i;
    } || function(t, i) {
  ...
  function(e) {
    ...
    return Object.defineProperty(n.prototype, "parentNode", {
      ...
      var i = this.props.scale || 1, s = this.props.resizeRatio || 1, o = this.state, a = o.direction, l = o.original, c = this.props, f = c.lockAspectRatio, h = c.lockAspectRatioExtraHeight, d = c.lockAspectRatioExtraWidth, g = l.width, m = l.height, w = h || 0, T = d || 0;
      ...
      var o = this.props, a = o.lockAspectRatio, l = o.lockAspectRatioExtraHeight, c = o.lockAspectRatioExtraWidth, f = typeof s.width > "u" ? 10 : s.width, h = typeof i.width > "u" || i.width < 0 ? r : i.width, d = typeof s.height > "u" ? 10 : s.height, g = typeof i.height > "u" || i.height < 0 ? t : i.height, m = l || 0, w = c || 0;
      if (a) {
        var T = (d - m) * this.ratio + w, E = (g - m) * this.ratio + w, b = (f - w) / this.ratio + m, M = (h - w) / this.ratio + m, A = Math.max(f, T), N = Math.min(h, E), ee = Math.max(d, b), q = Math.min(g, M);
        r = At(r, A, N), t = At(t, ee, q);
      } else
        r = At(r, f, h), t = At(t, d, g);
      ...
      if (!(!this.resizable || !this.window)) {
        var i = 0, s = 0;
        if (r.nativeEvent && $o(r.nativeEvent) ? (i = r.nativeEvent.clientX, s = r.nativeEvent.clientY) : r.nativeEvent && Nt(r.nativeEvent) && (i = r.nativeEvent.touches[0].clientX, s = r.nativeEvent.touches[0].clientY), this.props.onResizeStart && this.resizable) {
      ...
      if (!(!this.state.isResizing || !this.resizable || !this.window)) {
        ...
        var t = this.props, i = t.maxWidth, s = t.maxHeight, o = t.minWidth, a = t.minHeight, l = Nt(r) ? r.touches[0].clientX : r.clientX, c = Nt(r) ? r.touches[0].clientY : r.clientY, f = this.state, h = f.direction, d = f.original, g = f.width, m = f.height, w = this.getParentSize(), T = qo(w, this.window.innerWidth, this.window.innerHeight, i, s, o, a);
      ...
      var f = Object.keys(i).map(function(h) {
        return i[h] !== !1 ? R.createElement(Ao, { key: h, direction: h, onResizeStart: r.onResizeStart, replaceStyles: s && s[h], className: o && o[h] }, c && c[h] ? c[h] : null) : null;
      });
      return R.createElement("div", { className: l, style: a }, f);
    }, n.prototype.render = function() {
      var r = this, t = Object.keys(this.props).reduce(function(o, a) {
        return Yo.indexOf(a) !== -1 || (o[a] = r.props[a]), o;
    ...
    return n.prototype.componentDidMount = function() {
      ...
      if (this.originalPosition = i, !!this.props.bounds) {
        ...
        if (this.props.bounds === "parent")
          ...
          var l = s.getBoundingClientRect(), c = l.left, f = l.top, h = document.body.getBoundingClientRect(), d = -(c - s.offsetLeft * o - h.left) / o, g = -(f - s.offsetTop * o - h.top) / o, m = (document.body.offsetWidth - this.resizable.size.width * o) / o + d, w = (document.body.offsetHeight - this.resizable.size.height * o) / o + g;
          return this.setState({ bounds: { top: g, right: m, bottom: w, left: d } });
      ...
      if (this.resizingPosition = { x: a.x + o.left, y: a.y + o.top }, this.originalPosition = a, this.props.bounds) {
        ...
        if (f instanceof Element && (c instanceof HTMLElement || c === window) && l instanceof HTMLElement) {
          var h = this.getMaxSizesFromProps(), d = h.maxWidth, g = h.maxHeight, m = this.getParentSize();
          if (d && typeof d == "string")
            if (d.endsWith("%")) {
              var w = Number(d.replace("%", "")) / 100;
              d = m.width * w;
            } else
          ...
          if ((H || L) && this.resizable) {
            ...
            this.setState({ maxWidth: C > Number(d) ? d : C });
          }
      ...
      var f = this.offsetFromParent, h = this.getDraggablePosition().x + f.left, d = this.getDraggablePosition().y + f.top;
      this.resizingPosition = { x: h, y: d }, this.props.onResize && this.props.onResize(r, t, i, s, {
        x: h,
        y: d
      });
      ...
      var r = this.props, t = r.disableDragging, i = r.style, s = r.dragHandleClassName, o = r.position, a = r.onMouseDown, l = r.onMouseUp, c = r.dragAxis, f = r.dragGrid, h = r.bounds, d = r.enableUserSelectHack, g = r.cancel, m = r.children;
      r.onResizeStart, r.onResize, r.onResizeStop, r.onDragStart, r.onDrag, r.onDragStop;
      var w = r.resizeHandleStyles, T = r.resizeHandleClasses, E = r.resizeHandleComponent, b = r.enableResizing, M = r.resizeGrid, A = r.resizeHandleWrapperClass, N = r.resizeHandleWrapperStyle, ee = r.scale, q = r.allowAnyClick, H = Ko(r, ["disableDragging", "style", "dragHandleClassName", "position", "onMouseDown", "onMouseUp", "dragAxis", "dragGrid", "bounds", "enableUserSelectHack", "cancel", "children", "onResizeStart", "onResize", "onResizeStop", "onDragStart", "onDrag", "onDragStop", "resizeHandleStyles", "resizeHandleClasses", "resizeHandleComponent", "enableResizing", "resizeGrid", "resizeHandleWrapperClass", "resizeHandleWrapperStyle", "scale", "allowAnyClick"]), j = this.props.default ? ue({}, this.props.default) : void 0;
      delete H.default;
      var L = t || s ? { cursor: "auto" } : { cursor: "move" }, U = ue(ue(ue({}, Jo), L), i), C = this.offsetFromParent, F = C.left, X = C.top, J;
      o && (J = {
        x: o.x - F,
        y: o.y - X
      });
      ...
      return R.createElement(
        Go,
        { ref: this.refDraggable, handle: s ? ".".concat(s) : void 0, defaultPosition: j, onMouseDown: a, onMouseUp: l, onStart: this.onDragStart, onDrag: this.onDrag, onStop: this.onDragStop, axis: K, disabled: t, grid: f, bounds: h ? this.state.bounds : void 0, position: G, enableUserSelectHack: d, cancel: g, scale: ee, allowAnyClick: q, nodeRef: this.resizableElement },
        R.createElement(Xo, ue({}, H, { ref: this.refResizable, defaultSize: j, size: this.props.size, enable: typeof b == "boolean" ? Zo(b) : b, onResizeStart: this.onResizeStart, onResize: this.onResize, onResizeStop: this.onResizeStop, style: U, minWidth: this.props.minWidth, minHeight: this.props.minHeight, maxWidth: this.state.resizing ? this.state.maxWidth : this.props.maxWidth, maxHeight: this.state.resizing ? this.state.maxHeight : this.props.maxHeight, grid: M, handleWrapperClass: A, handleWrapperStyle: N, lockAspectRatio: this.props.lockAspectRatio, lockAspectRatioExtraWidth: this.props.lockAspectRatioExtraWidth, lockAspectRatioExtraHeight: this.props.lockAspectRatioExtraHeight, handleStyles: w, handleClasses: T, handleComponent: E, scale: this.props.scale }), m)
      );
    }, n.defaultProps = {
...
const ea = [{
  ...
  const i = e.selectionDirection, s = ea.filter((o) => n ? !0 : !o.onBlur || !1).reduce((o, a) => {
  ...
  const K = R.useMemo(() => a ? (A == null ? void 0 : A.map((u) => o.find((p) => p[i] == u)).filter((u) => !!u)) || [] : o.find((u) => u[i] == A) || null, [A, o]), {
    value: Z,
    getRootProps: te,
    getInputProps: ie,
    getListboxProps: pe,
    ...
    value: K,
    getOptionLabel: X,
    isOptionEqualToValue: (u, p) => i ? u[i] === p[i] : u === p,
    onInputChange: T,
    onOpen: (u) => {
      G(!0), d == null || d(u);
    },
    ...
    onChange: (u, p) => {
      w && (Array.isArray(p) ? w(p.map((v) => v[i])) : w(p && typeof p == "object" ? p[i] : null)), E == null || E(p);
    }
  }), I = R.useMemo(() => j ? j({
    closePopup: () => G(!1)
    ...
    "--tw-text-opacity": "1",
    color: "rgb(107 114 128 / var(--tw-text-opacity))"
  }, children: /* @__PURE__ */ B(ia, {}) }) : /* @__PURE__ */ B("ul", { css: {
    zIndex: "20",
    width: "100%"
  }, ...pe(), children: D && S.length > 0 ? /* @__PURE__ */ Ee(yt, { children: [
    S.map((u, p) => /* @__PURE__ */ B(ne.Fragment, { children: "group" in u ? /* @__PURE__ */ B(yt, {}) : /* @__PURE__ */ B("li", { css: [{
      cursor: "pointer",
      "--tw-border-opacity": "1",
      ...
      option: u,
      index: p
    }), children: m ? m(u) : X(u) }) }, i in u ? u[i] : p)),
    I
    ...
    isLoading: t,
    onDelete: (u) => {
      w == null || w(Z.filter((p) => p[i] !== u[i]).map((p) => p[i]));
    },
    valueCount: (A == null ? void 0 : A.length) || 0
  }) : /* @__PURE__ */ B(na, { items: Z, optionRender: m, getOptionLabel: X, getTagProps: $, isLoading: t, valueCount: A == null ? void 0 : A.length }) : null, [Z, U]), Ne = /* @__PURE__ */ Ee(yt, { children: [
    L === "top" && Se,
    /* @__PURE__ */ B(Tt, { ...C, error: h, ...Ce, ref: Be, inputWrapRef: O, placeholder: M, isLoading: r, useTypograf: !1, onChange: we, onBlur: (u) => {
      ...
      u.preventDefault(), u.stopPropagation(), G((p) => !p);
    }, children: /* @__PURE__ */ B(Ye, { css: [{
      marginBottom: "1px",
      fontSize: "0.875rem",
      lineHeight: "1.25rem",
...
}, fi = R.forwardRef(sa), oa = (e, n) => {
  const [r, t] = R.useState(!1);
  return /* @__PURE__ */ B(Yi, { ref: n, type: r ? "text" : "password", InputProps: {
    endAdornment: /* @__PURE__ */ B($i, { position: "end", children: /* @__PURE__ */ B(qi, { size: "small", edge: "end", onClick: () => t((i) => !i), children: /* @__PURE__ */ B(Ye, { css: [{
      fontSize: "0.875rem",
      lineHeight: "1.25rem"
    }, zr`
                  width: 18px;
                `], icon: r ? Li.faEyeSlash : Gi.faEye }) }) })
  }, ...e });
};
R.forwardRef(oa);
const _r = (e) => Array.isArray(e) ? e.length === 0 : !e, aa = ({
  dictionary: e,
  open: n = !1,
  value: r,
  filterOptions: t,
...
function di(e, n, r) {
  return (n = ua(n)) in e ? Object.defineProperty(e, n, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[n] = r, e;
}
function la(e, n) {
  if (e == null)
    return {};
...
function mn(e, n) {
  for (var r = n.start, t = r === void 0 ? 0 : r, i = n.end, s = n.mask, o = n.replacement, a = n.separate, l = e.slice(t, i), c = s.slice(t, i), f = "", h = 0; h < c.length; h++) {
    var d = Object.prototype.hasOwnProperty.call(o, c[h]);
    d && l[h] !== void 0 && l[h] !== c[h] ? f += l[h] : d && a && (f += c[h]);
  }
  return f;
}
function bn(e) {
...
var ut = function(e) {
  function n(r, t) {
    var i;
    return pa(this, n), (i = da(this, n, [r])).name = "SyntheticChangeError", i.cause = t, i;
  }
  return ga(n, e), ha(n);
}(Rr(Error));
function va(e, n) {
...
var ya = ["text", "email", "tel", "search", "url"];
function ma(e) {
  ...
  return l.current.init = n, l.current.tracking = r, l.current.eventType = t, l.current.eventHandler = i, R.useMemo(function() {
    return function(c, f, h) {
      var d = h.onFocus, g = h.onBlur, m = h.onInput;
      return new Proxy(c, { set: function(w, T, E) {
        if (T !== "current")
          return !1;
        var b = E !== null && ya.includes(E.type);
        if (E !== c.current && (c.current !== null && (c.current.removeEventListener("focus", d), c.current.removeEventListener("blur", g), c.current.removeEventListener("input", m)), E !== null && b)) {
          ...
          Lt(E, { value: j.value }), document.activeElement === E && d(), E.addEventListener("focus", d), E.addEventListener("blur", g), E.addEventListener("input", m);
        }
        return w[T] = E, !0;
      } });
      ...
      s.current.timeoutId = window.setTimeout(function c() {
        var f, h, d, g;
        o.current ? (s.current.start = (f = (h = a.current) === null || h === void 0 ? void 0 : h.selectionStart) !== null && f !== void 0 ? f : 0, s.current.end = (d = (g = a.current) === null || g === void 0 ? void 0 : g.selectionEnd) !== null && d !== void 0 ? d : 0, s.current.timeoutId = window.setTimeout(c)) : s.current.fallbackTimeoutId = window.setTimeout(c);
      });
    }, onBlur: function() {
      ...
      if (f !== null)
        try {
          ...
          var M, A = (h = (d = f._valueTracker) === null || d === void 0 || (g = d.getValue) === null || g === void 0 ? void 0 : g.call(d)) !== null && h !== void 0 ? h : "";
...
function hi() {
  var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, n = e.mask, r = n === void 0 ? "" : n, t = e.replacement, i = t === void 0 ? {} : t, s = e.showMask, o = s !== void 0 && s, a = e.separate, l = a !== void 0 && a, c = e.track, f = e.modify, h = e.onMask, d = typeof i == "string" ? Dr(i) : i, g = R.useRef(null);
  return ma({ init: function(m) {
    var w = m.controlled, T = m.initialValue;
    T = w || T ? T : o ? r : "";
    var E = { mask: r, replacement: d, showMask: o, separate: l };
    ...
    var C = N + b + j, F = (w = f == null ? void 0 : f(C)) !== null && w !== void 0 ? w : {}, X = F.mask, J = X === void 0 ? r : X, G = F.replacement, K = G === void 0 ? d : G, Z = F.showMask, te = Z === void 0 ? o : Z, ie = F.separate, pe = ie === void 0 ? l : ie;
    typeof K == "string" && (K = Dr(K));
    var y = function(x, O) {
      var D = O.mask, W = O.replacement, $ = O.showMask, I = ca(x, { mask: D, replacement: W, showMask: $ }), Y = fa(I, { mask: D, replacement: W }), be = bn({ mask: D, replacement: W }), he = bn({ mask: D, replacement: W }, !0);
      return { value: I, input: x, parts: Y, pattern: be, isValid: RegExp(he).test(I) };
    }(C, { mask: J, replacement: K, showMask: te }), S = function(x) {
      var O, D, W, $ = x.inputType, I = x.value, Y = x.addedValue, be = x.beforeChangeValue, he = x.parts, we = x.replacement, _e = x.separate, Ce = he.filter(function(p) {
        var v = p.type;
      ...
      var u = I.split("").findIndex(function(p) {
        return Object.prototype.hasOwnProperty.call(we, p);
      });
...
var ba = ["component", "mask", "replacement", "showMask", "separate", "track", "modify", "onMask"];
function wa(e, n) {
  var r = e.component, t = e.mask, i = e.replacement, s = e.showMask, o = e.separate, a = e.track, l = e.modify, c = e.onMask, f = la(e, ba), h = hi({ mask: t, replacement: i, showMask: s, separate: o, track: a, modify: l, onMask: c }), d = va(h, n);
  return Xi.jsx(r || "input", Or({ ref: d }, f));
}
R.forwardRef(wa);
const Sa = ({
  error: e,
  ...
  return /* @__PURE__ */ B(Qi, { onClickAway: () => E(!1), children: /* @__PURE__ */ Ee(Jt, { className: t, label: n, error: e, children: [
    /* @__PURE__ */ B(Tt, { ...d, inputWrapRef: j, ref: g, onFocus: q, onBlur: H, useTypograf: !1, value: A, onChange: (L) => {
    ...
    m && /* @__PURE__ */ B(Pn, { open: T, anchorEl: m, placement: "bottom-start", modifiers: [{
      ...
      "--tw-drop-shadow": "drop-shadow(0 10px 8px rgb(0 0 0 / 0.04)) drop-shadow(0 4px 3px rgb(0 0 0 / 0.1))",
      filter: "var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)"
    }, children: /* @__PURE__ */ B(Di, { value: a, onChange: (L) => {
  ...
  const [h, d] = R.useState(""), [g, m] = R.useState(a), w = ls(h, 500), T = us(r, i), {
    records: E,
    isLoading: b
  } = as({
    idField: i,
  ...
  return /* @__PURE__ */ B(yt, { children: /* @__PURE__ */ B(fi, { ref: f, multiple: e, value: n, ...c, disabled: q || c.disabled, inputLoading: q, options: ee, idField: i, onOpen: () => m(!0), onClose: () => m(!1), isLoading: N.isLoading || b, valueLoading: b, popupAdditionalOptionsRenderer: H, open: g, afterItems: [(N.isLoading || N.isFetching || e && b) && /* @__PURE__ */ B("div", { children: /* @__PURE__ */ B(Ye, { icon: _n.faCircleNotch, css: {
    ...
    U === "input" && d(L), U === "reset" && h !== "" && d(""), s == null || s(j, L, U);
  } }) });
}, Ua = R.forwardRef(xa), _a = ({
  unit: e,
  error: n,
  onChange: r,
  allowFloat: t = !0,
  ...
  const h = zn(o, f);
  return /* @__PURE__ */ B(Tt, { ...s, ref: h, error: n, value: a, useTypograf: !1, onChange: (d) => {
    const g = Number(d.target.value);
    if (!isNaN(g)) {
      if (d.target.value.includes(".") && !t)
        return;
      l(d.target.value), d.target.value.slice(-1) !== "." && (r == null || r(g));
    }
...
}, $a = R.forwardRef(_a), Oa = R.forwardRef(({
  placeholder: e = "Введите",
  ...n
}, r) => /* @__PURE__ */ B("textarea", { ref: r, placeholder: e, ...n })), Da = ({
  error: e,
  rows: n = 5,
  ...r
}, t) => /* @__PURE__ */ B(Tt, { ...r, ref: t, rows: n, inputComponent: Oa, error: e }), qa = R.forwardRef(Da), Ea = ({
  error: e,
  ...n
}, r) => /* @__PURE__ */ B(Tt, { useTypograf: !1, ...n, ref: r, error: e }), Ya = R.forwardRef(Ea), Ra = ({
  label: e,
  error: n,
  value: r,
  helperText: t,
  ...
  onChange: s,
  ...o
}, a) => /* @__PURE__ */ B(Jt, { label: e, error: n, helperText: t, className: i, children: /* @__PURE__ */ Ee(Ki, { value: r === !0 ? "true" : r === !1 ? "false" : void 0, ...o, onChange: (l) => {
