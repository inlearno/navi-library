import { Q as f, j as l, F as y } from "./library-72beada2.js";
import { f as b } from "./faPen-6d05924c.js";
import { u as P, P as C, T as D, c as z } from "./index-33208ba3.js";
import { u as H, P as _ } from "./useDictionary-464da608.js";
import { g as m, r as u } from "./react-181b9648.js";
...
var L = function(e, r, o, a) {
  ...
  if (typeof window.navigator.msSaveBlob < "u")
    ...
    var s = window.URL && window.URL.createObjectURL ? window.URL.createObjectURL(i) : window.webkitURL.createObjectURL(i), n = document.createElement("a");
...
(function(e) {
  ...
  var r = "fas", o = "plus", a = 448, t = 512, i = [10133, 61543, "add"], s = "2b", n = "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z";
  e.definition = {
    prefix: r,
    iconName: o,
    icon: [
  ...
  }, e.faPlus = e.definition, e.prefix = r, e.iconName = o, e.width = a, e.height = t, e.ligatures = i, e.unicode = s, e.svgPathData = n, e.aliases = i;
})(p);
var v = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  var r = "fas", o = "copy", a = 448, t = 512, i = [], s = "f0c5", n = "M208 0H332.1c12.7 0 24.9 5.1 33.9 14.1l67.9 67.9c9 9 14.1 21.2 14.1 33.9V336c0 26.5-21.5 48-48 48H208c-26.5 0-48-21.5-48-48V48c0-26.5 21.5-48 48-48zM48 128h80v64H64V448H256V416h64v48c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V176c0-26.5 21.5-48 48-48z";
  e.definition = {
    prefix: r,
    iconName: o,
    icon: [
  ...
  }, e.faCopy = e.definition, e.prefix = r, e.iconName = o, e.width = a, e.height = t, e.ligatures = i, e.unicode = s, e.svgPathData = n, e.aliases = i;
})(v);
var w = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  var r = "fas", o = "download", a = 512, t = 512, i = [], s = "f019", n = "M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32V274.7l-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7V32zM64 352c-35.3 0-64 28.7-64 64v32c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V416c0-35.3-28.7-64-64-64H346.5l-45.3 45.3c-25 25-65.5 25-90.5 0L165.5 352H64zm368 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48z";
  e.definition = {
    prefix: r,
    iconName: o,
    icon: [
  ...
  }, e.faDownload = e.definition, e.prefix = r, e.iconName = o, e.width = a, e.height = t, e.ligatures = i, e.unicode = s, e.svgPathData = n, e.aliases = i;
})(w);
const c = z(), Y = () => {
  const e = S(), {
    download: r
  } = B(), o = u.useMemo(() => [c.id(), c.actions([{
    key: "download",
    icon: w.faDownload,
    ...
    onClick: async (t) => {
      ...
      try {
        await r(`/api/program-docs/${t.id}/download`), f.dismiss(i);
      } catch {
        f.update(i, {
          autoClose: 5e3,
          type: "error",
