...
const ww = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-ffca53cc.js"),
  windowOptions: {
    icon: Qu.faUsers,
    title: "Пользователи",
    width: 800
  ...
  id: "user-profile",
  path: "/user-profile",
  component: () => import("./UserProfile-724f1417.js"),
  windowOptions: {
    icon: Dd.faUserGear,
    title: "Профиль",
    width: 400,
...
const _w = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-64304910.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-caa9dcf2.js"),
  privilege: "ProgramDocsView",
  windowOptions: {
  ...
  component: () => import("./Draft-d3603123.js"),
  ...
  component: () => import("./CopyProgramForm-6cf7109c.js"),
  windowOptions: {
  ...
  component: () => import("./Dictionaries-9be0435a.js"),
  windowOptions: {
    title: "Справочники",
    width: 700,
    height: 500,
