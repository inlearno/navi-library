...
const J_ = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-544283ba.js"),
  windowOptions: {
    icon: gl.faUsers,
    title: "Пользователи",
    width: 800
  ...
  id: "user-profile",
  path: "/user-profile",
  component: () => import("./UserProfile-bbabe800.js"),
  windowOptions: {
    icon: lp.faUserGear,
    title: "Профиль",
    width: 400,
...
const eE = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-8f7af253.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-8e3a16b4.js"),
  privilege: "ProgramDocsView",
  windowOptions: {
  ...
  component: () => import("./Draft-22bb97c7.js"),
  ...
  privilege: "ProgramDocsEdit",
  component: () => import("./CopyProgramForm-83fa0a74.js"),
  windowOptions: {
  ...
  privilege: "ProgramDocsView",
  component: () => import("./Dictionaries-51ffa7bd.js"),
  windowOptions: {
    title: "Справочники",
    width: 700,
    height: 500,
...
const tE = [{
  id: "partner-profile",
  path: "/profile",
  component: () => import("./PartnerProfile-e84f7f7d.js"),
  windowOptions: {
    title: "",
    icon: yl.faUser,
    width: 850,
...
const nE = [{
  ...
  component: () => import("./TeacherProfile-08e77b98.js"),
  windowOptions: {
    title: "",
