...
import { L, O as N, P as T, T as A, V as Q, I as U, W as H, X as _, l as K, Q as q, b as F, j as P, Y as V } from "./library-7049cee8.js";
import { r as M } from "./react-6f5a8403.js";
import { s as W, u as X } from "./DictionaryCell-f2791dc0.js";
import { F as z } from "./icons-ad9f8a73.js";
import { B as Y } from "./mui-2ff488a7.js";
var y, v, h, m, O, R, j, I, B, $ = (B = class extends L {
  constructor(t, s) {
    super();
    g(this, O);
    g(this, j);
  ...
  setOptions(t) {
    ...
    this.options = r(this, y).defaultMutationOptions(t), N(this.options, s) || r(this, y).getMutationCache().notify({
  ...
  var s;
  const t = ((s = r(this, h)) == null ? void 0 : s.state) ?? A();
  E(this, v, {
    ...t,
...
function G(e, t) {
  ...
  const o = M.useSyncExternalStore(
    ...
    (a, u) => {
      i.mutate(a, u).catch(J);
    },
    [i]
  );
  if (o.error && W(i.options.throwOnError, [o.error]))
    throw o.error;
...
function nt(e, t, s) {
  ...
  const o = M.useMemo(() => H(i.url, {
    encode: encodeURIComponent
  }), [i.url]), n = M.useMemo(() => _(i.url).reduce((f, d) => typeof d != "string" ? [...f, d.name] : f, []), [i.url]), a = X(), {
    wrapPayload: u = !0,
    syncQueryCache: x = !1,
    ...l
  } = i, p = U();
...
const at = ({
  ...
  let u = /* @__PURE__ */ F(Y, { className: t, size: n || "small", css: {
    display: "flex",
  ...
  return s && (u = /* @__PURE__ */ P(V, { title: s, arrow: !0, children: u })), u;
};
var Z = {};
(function(e) {
