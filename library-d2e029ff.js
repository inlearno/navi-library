...
const ww = [{
  id: "users",
  path: "/users",
  component: () => import("./UsersList-b9058e0a.js"),
  windowOptions: {
    icon: Qu.faUsers,
    title: "Пользователи",
    width: 800
  ...
  id: "user-profile",
  path: "/user-profile",
  component: () => import("./UserProfile-47fe8f5f.js"),
  windowOptions: {
    icon: Dd.faUserGear,
    title: "Профиль",
    width: 400,
...
const _w = [{
  id: "program-docs",
  path: "/program-docs",
  component: () => import("./ProgramDocsList-37779c0d.js"),
  windowOptions: {
  ...
  component: () => import("./ProgramConstructor-06df269f.js"),
  privilege: "ProgramDocsView",
  windowOptions: {
  ...
  component: () => import("./Draft-6d12ccee.js"),
  ...
  component: () => import("./CopyProgramForm-88c7ab14.js"),
  windowOptions: {
  ...
  component: () => import("./Dictionaries-0da0eb9e.js"),
  windowOptions: {
    title: "Справочники",
    width: 700,
    height: 500,
